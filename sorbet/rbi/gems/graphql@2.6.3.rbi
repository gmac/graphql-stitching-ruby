...
# pkg:gem/graphql#lib/graphql/autoload.rb:3
module GraphQL
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql.rb:49
    ...
    # @return [GraphQL::Language::Nodes::Document]
    #
    # pkg:gem/graphql#lib/graphql.rb:56
    def parse_file(filename); end

    # pkg:gem/graphql#lib/graphql.rb:66
    ...
    #
    # pkg:gem/graphql#lib/graphql.rb:84
    ...
    # @return [Array<Array>]
    #
    # pkg:gem/graphql#lib/graphql.rb:62
    def scan(graphql_string); end

    # pkg:gem/graphql#lib/graphql.rb:71
    def scan_with_ruby(graphql_string); end
  end
end

# pkg:gem/graphql#lib/graphql/analysis/visitor.rb:3
module GraphQL::Analysis
  private

  # pkg:gem/graphql#lib/graphql/analysis.rb:90
  def analysis_errors(parent_errors, results); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis.rb:27
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis.rb:56
...
# pkg:gem/graphql#lib/graphql/analysis.rb:11
...
#
# pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:11
class GraphQL::Analysis::Analyzer
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:12
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:27
  def analyze?; end

  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:50
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:41
  def result; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:34
  def visit?; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:87
  def multiplex; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:84
  def query; end

  # @return [GraphQL::Query, GraphQL::Execution::Multiplex] Whatever this analyzer is analyzing
  #
  # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:80
  def subject; end

  class << self
    private

    # pkg:gem/graphql#lib/graphql/analysis/analyzer.rb:49
    def build_visitor_hooks(member_name); end
  end
end

# pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:4
class GraphQL::Analysis::FieldUsage < ::GraphQL::Analysis::Analyzer
  # pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:5
  def initialize(query); end

  # pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:13
  def on_leave_field(node, parent, visitor); end

  # pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:26
  def result; end

  private

  # pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:37
  def extract_deprecated_arguments(argument_values); end

  # pkg:gem/graphql#lib/graphql/analysis/field_usage.rb:74
...
#
# pkg:gem/graphql#lib/graphql/analysis/max_query_complexity.rb:6
class GraphQL::Analysis::MaxQueryComplexity < ::GraphQL::Analysis::QueryComplexity
  # pkg:gem/graphql#lib/graphql/analysis/max_query_complexity.rb:7
  def result; end
end

# pkg:gem/graphql#lib/graphql/analysis/max_query_depth.rb:4
class GraphQL::Analysis::MaxQueryDepth < ::GraphQL::Analysis::QueryDepth
  # pkg:gem/graphql#lib/graphql/analysis/max_query_depth.rb:5
  def result; end
end

# Calculate the complexity of a query, using {Field#complexity} values.
#
# pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:5
class GraphQL::Analysis::QueryComplexity < ::GraphQL::Analysis::Analyzer
  # State for the query complexity calculation:
  # - `complexities_on_type` holds complexity scores for each type
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:8
  def initialize(query); end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:80
  def on_enter_field(node, parent, visitor); end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:98
  def on_leave_field(node, parent, visitor); end

  # Override this method to use the complexity result
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:17
  def result; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:188
  def field_complexity(scoped_type_complexity, max_complexity:, child_complexity: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:237
  def legacy_merged_max_complexity(query, inner_selections); end

  # @return [Integer]
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:111
  def max_possible_complexity(mode: T.unsafe(nil)); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:193
  ...
  # @return [Integer]
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:121
  def merged_max_complexity_for_scopes(query, scopes, mode); end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:162
...
#
# pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:48
class GraphQL::Analysis::QueryComplexity::ScopedTypeComplexity < ::Hash
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:59
  def initialize(parent_type, field_definition, query, response_path); end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:75
  def composite?; end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:52
  def field_definition; end

  # @return [Array<GraphQL::Language::Nodes::Field>]
  #
  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:69
  def nodes; end

  # pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:71
...
#
# pkg:gem/graphql#lib/graphql/analysis/query_complexity.rb:50
...
#
# pkg:gem/graphql#lib/graphql/analysis/query_depth.rb:26
class GraphQL::Analysis::QueryDepth < ::GraphQL::Analysis::Analyzer
  # pkg:gem/graphql#lib/graphql/analysis/query_depth.rb:27
  def initialize(query); end

  # pkg:gem/graphql#lib/graphql/analysis/query_depth.rb:34
  def on_enter_field(node, parent, visitor); end

  # pkg:gem/graphql#lib/graphql/analysis/query_depth.rb:42
  def on_leave_field(node, parent, visitor); end

  # pkg:gem/graphql#lib/graphql/analysis/query_depth.rb:53
  def result; end
end
...
#
# pkg:gem/graphql#lib/graphql/analysis/visitor.rb:12
class GraphQL::Analysis::Visitor < ::GraphQL::Language::StaticVisitor
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:13
  def initialize(query:, analyzers:, timeout:); end

  # @return [GraphQL::Argument, nil] The most-recently-entered GraphQL::Argument, if currently inside one
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:235
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:53
  def arguments_for(ast_node, field_definition); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:78
  ...
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:230
  def directive_definition; end

  # @return [GraphQL::Field, nil] The most-recently-entered GraphQL::Field, if currently inside one
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:220
  def field_definition; end

  # @return [Array<GraphQL::ObjectType>] Types whose scope we've entered
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:39
  def object_types; end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:168
  def on_argument(node, parent); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:158
  def on_directive(node, parent); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:130
  def on_field(node, parent); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:194
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:111
  def on_inline_fragment(node, parent); end

  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:99
  def on_operation_definition(node, parent); end

  # @return [GraphQL::BaseType] The type which the current type came from
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:215
  def parent_type_definition; end

  # @return [GraphQL::Argument, nil] The previous GraphQL argument
  #
  # pkg:gem/graphql#lib/graphql/analysis/visitor.rb:240
...
module GraphQL::Autoload
  ...
  #
  # pkg:gem/graphql#lib/graphql/autoload.rb:34
...
#   end
#
# pkg:gem/graphql#lib/graphql/backtrace/table.rb:3
class GraphQL::Backtrace
  include ::Enumerable
  extend ::Forwardable

  # pkg:gem/graphql#lib/graphql/backtrace.rb:27
  ...
  # pkg:gem/graphql#lib/graphql/backtrace.rb:37
  def to_a; end

  # pkg:gem/graphql#lib/graphql/backtrace.rb:35
  def to_s; end

  class << self
    # pkg:gem/graphql#lib/graphql/backtrace.rb:23
...
class GraphQL::Backtrace::Table
  ...
  #
  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:27
  def to_backtrace; end

  # @return [String] A table layout of backtrace with metadata
  #
  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:22
  def to_table; end

  private

  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:123
  def find_ast_node(node, last_part); end

  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:182
  def inspect_result(obj); end

  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:199
  def inspect_truncated(obj); end

  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:138
  def render_table(rows); end

  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:38
  def rows; end

  # pkg:gem/graphql#lib/graphql/backtrace/table.rb:174
  def value_at(runtime, path); end
end

# pkg:gem/graphql#lib/graphql/backtrace/table.rb:8
GraphQL::Backtrace::Table::HEADERS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/backtrace/table.rb:7
GraphQL::Backtrace::Table::MAX_COL_WIDTH = T.let(T.unsafe(nil), Integer)

# pkg:gem/graphql#lib/graphql/backtrace/table.rb:6
...
class GraphQL::Backtrace::TracedError < ::GraphQL::Error
  ...
  #
  # pkg:gem/graphql#lib/graphql/backtrace/traced_error.rb:10
  def context; end

  # @return [Array<String>] Printable backtrace of GraphQL error context
  #
  # pkg:gem/graphql#lib/graphql/backtrace/traced_error.rb:7
...
#
# pkg:gem/graphql#lib/graphql/backtrace/traced_error.rb:26
GraphQL::Backtrace::TracedError::CAUSE_BACKTRACE_PREVIEW_LENGTH = T.let(T.unsafe(nil), Integer)

# pkg:gem/graphql#lib/graphql/backtrace/traced_error.rb:12
...
module GraphQL::Current
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/current.rb:43
    def field; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/current.rb:26
...
class GraphQL::Dataloader
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:144
  def append_job(callable = T.unsafe(nil), &job); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:102
  def cleanup_fiber; end

  # Clear any already-loaded objects from {Source} caches
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:153
  def clear_cache; end

  # @return [Integer, nil]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:71
  def fiber_limit; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:81
  def get_fiber_variables; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:246
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:265
  def merge_records(records, index_by: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:73
  def nonblocking?; end

  # @param trace_query_lazy [nil, Execution::Multiplex]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:198
  def run(trace_query_lazy: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:241
  def run_fiber(f); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:95
  def set_fiber_variables(vars); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:250
  def spawn_fiber; end

  # truffle-ruby wasn't doing well with the implementation below
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:121
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/dataloader.rb:135
  ...
  # pkg:gem/graphql#lib/graphql/dataloader.rb:341
  def join_queues(prev_queue, new_queue); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:277
  def run_next_pending_lazies(job_fibers, trace); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:297
  ...
  # pkg:gem/graphql#lib/graphql/dataloader.rb:347
  def spawn_job_fiber(trace); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:359
  def spawn_source_fiber(trace); end

  # pkg:gem/graphql#lib/graphql/dataloader.rb:321
  def with_trace_query_lazy(multiplex_or_nil, &block); end

  class << self
    # pkg:gem/graphql#lib/graphql/dataloader.rb:29
    ...
    # pkg:gem/graphql#lib/graphql/dataloader.rb:32
    ...
    #
    # pkg:gem/graphql#lib/graphql/dataloader.rb:50
    def with_dataloading(&block); end
  end
end

# pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:7
class GraphQL::Dataloader::ActiveRecordAssociationSource < ::GraphQL::Dataloader::Source
  # pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:10
  def initialize(association, scope = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:31
  def fetch(records); end

  # pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:23
  def load(record); end

  class << self
    # pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:15
    def batch_key_for(association, scope = T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/dataloader/active_record_association_source.rb:8
GraphQL::Dataloader::ActiveRecordAssociationSource::RECORD_SOURCE_CLASS = GraphQL::Dataloader::ActiveRecordSource

# pkg:gem/graphql#lib/graphql/dataloader/active_record_source.rb:6
class GraphQL::Dataloader::ActiveRecordSource < ::GraphQL::Dataloader::Source
  # pkg:gem/graphql#lib/graphql/dataloader/active_record_source.rb:7
  def initialize(model_class, find_by: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/dataloader/active_record_source.rb:32
  def fetch(record_ids); end

  # pkg:gem/graphql#lib/graphql/dataloader/active_record_source.rb:22
  def normalize_fetch_key(requested_key); end

  # pkg:gem/graphql#lib/graphql/dataloader/active_record_source.rb:18
...
class GraphQL::Dataloader::NullDataloader < ::GraphQL::Dataloader
  ...
  # pkg:gem/graphql#lib/graphql/dataloader/null_dataloader.rb:53
  def clear_cache; end

  # pkg:gem/graphql#lib/graphql/dataloader/null_dataloader.rb:14
  def freeze; end

  # pkg:gem/graphql#lib/graphql/dataloader/null_dataloader.rb:20
  def run(trace_query_lazy: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/dataloader/null_dataloader.rb:39
  def run_isolated; end
...
class GraphQL::Dataloader::Request
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/request.rb:14
  def load; end

  # pkg:gem/graphql#lib/graphql/dataloader/request.rb:18
...
class GraphQL::Dataloader::RequestAll < ::GraphQL::Dataloader::Request
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/request_all.rb:14
  def load; end
end
...
class GraphQL::Dataloader::Source
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/source.rb:63
  def load(value); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/source.rb:76
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/source.rb:21
  ...
  #
  # pkg:gem/graphql#lib/graphql/dataloader/source.rb:51
...
class GraphQL::DateEncodingError < ::GraphQL::RuntimeTypeError
  ...
  #
  # pkg:gem/graphql#lib/graphql/date_encoding_error.rb:9
  def date_value; end
end

# pkg:gem/graphql#lib/graphql/dig.rb:3
module GraphQL::Dig
  ...
  # @return [Object]
  #
  # pkg:gem/graphql#lib/graphql/dig.rb:11
...
#
# pkg:gem/graphql#lib/graphql/duration_encoding_error.rb:7
class GraphQL::DurationEncodingError < ::GraphQL::RuntimeTypeError
  # pkg:gem/graphql#lib/graphql/duration_encoding_error.rb:11
  def initialize(value); end

  # The value which couldn't be encoded
  #
  # pkg:gem/graphql#lib/graphql/duration_encoding_error.rb:9
  def duration_value; end
end

# pkg:gem/graphql#lib/graphql.rb:77
module GraphQL::EmptyObjects; end

# pkg:gem/graphql#lib/graphql.rb:79
GraphQL::EmptyObjects::EMPTY_ARRAY = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql.rb:78
GraphQL::EmptyObjects::EMPTY_HASH = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql.rb:21
class GraphQL::Error < ::StandardError; end

# pkg:gem/graphql#lib/graphql/execution/directive_checks.rb:3
...
# pkg:gem/graphql#lib/graphql/execution/errors.rb:5
class GraphQL::Execution::Errors
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/execution/errors.rb:56
...
# pkg:gem/graphql#lib/graphql/execution/field_resolve_step.rb:4
class GraphQL::Execution::FieldResolveStep
  ...
  def append_selection(ast_node); end
  ...
  # pkg:gem/graphql#lib/graphql/execution/field_resolve_step.rb:27
  def object_is_authorized; end

  # pkg:gem/graphql#lib/graphql/execution/field_resolve_step.rb:27
  def parent_type; end

  # pkg:gem/graphql#lib/graphql/execution/field_resolve_step.rb:32
  def path; end
...
# pkg:gem/graphql#lib/graphql/execution/finalize.rb:4
...
# pkg:gem/graphql#lib/graphql/execution/next.rb:12
module GraphQL::Execution::Finalizer
  # pkg:gem/graphql#lib/graphql/execution/next.rb:19
  def ast_node; end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:23
  def ast_node=(new_node); end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:27
  def ast_nodes; end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:27
  def ast_nodes=(_arg0); end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:15
  def finalize_graphql_result(query, result_data, result_key); end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:13
  def path; end
...
# pkg:gem/graphql#lib/graphql/execution/next.rb:30
module GraphQL::Execution::HaltExecution; end

# pkg:gem/graphql#lib/graphql/execution/input_values.rb:4
class GraphQL::Execution::InputValues
  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:5
  def initialize(query, runner); end

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:38
  def argument_values(owner_defn, argument_nodes, field_resolve_step); end

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:11
  def variable_values; end

  private

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:134
  def argument_value(argument_values, argument_key, argument_definition, arg_value, override_type, field_resolve_step); end

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:308
  def coerce_untyped_input(input_value); end

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:231
  def value_from_ast(value_node, type); end

  # pkg:gem/graphql#lib/graphql/execution/input_values.rb:66
  def variable_value(value, type); end
end
...
class GraphQL::Execution::Interpreter::ArgumentValue
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/argument_value.rb:26
  def default_used?; end

  # @return [GraphQL::Schema::Argument] The definition instance for this argument
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/argument_value.rb:23
  def definition; end

  # @return [Object] The value of this argument _before_ `prepare` is applied.
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/argument_value.rb:20
  def original_value; end

  # @return [Object] The Ruby-ready value for this Argument
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/argument_value.rb:17
  def value; end
end
...
#
# pkg:gem/graphql#lib/graphql/execution/interpreter/arguments.rb:12
class GraphQL::Execution::Interpreter::Arguments
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments.rb:56
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments.rb:20
...
# pkg:gem/graphql#lib/graphql/execution/interpreter/arguments.rb:83
...
class GraphQL::Execution::Interpreter::ArgumentsCache
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:35
  def cached_arguments_for(ast_node, argument_owner); end

  # @yield [Interpreter::Arguments, Lazy<Interpreter::Arguments>] The finally-loaded arguments
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:40
  def dataload_for(ast_node, argument_owner, parent_object, &block); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:24
  def fetch(ast_node, argument_owner, parent_object); end

  class << self
    # pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:60
    def prepare_args_hash(query, ast_arg_or_hash_or_value); end
  end
end

# pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:57
GraphQL::Execution::Interpreter::ArgumentsCache::NO_ARGUMENTS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/execution/interpreter/arguments_cache.rb:58
...
class GraphQL::Execution::Interpreter::ExecutionErrors
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/execution_errors.rb:13
  def add(err_or_msg); end
end

# pkg:gem/graphql#lib/graphql/execution/interpreter.rb:140
class GraphQL::Execution::Interpreter::ListResultFailedError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/execution/interpreter.rb:141
...
class GraphQL::Execution::Interpreter::RawValue
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/handles_raw_value.rb:14
  def initialize(obj = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/handles_raw_value.rb:10
  def finalize_graphql_result(query, result_data, result_key); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/handles_raw_value.rb:18
  def resolve; end
end

# pkg:gem/graphql#lib/graphql/execution/interpreter/resolve.rb:6
module GraphQL::Execution::Interpreter::Resolve
  class << self
    # @deprecated Call `dataloader.run` instead
    #
    # pkg:gem/graphql#lib/graphql/execution/interpreter/resolve.rb:43
    ...
    # @deprecated Call `dataloader.run` instead
    #
    # pkg:gem/graphql#lib/graphql/execution/interpreter/resolve.rb:10
    def resolve_all(results, dataloader); end

    # @deprecated Call `dataloader.run` instead
    #
    # pkg:gem/graphql#lib/graphql/execution/interpreter/resolve.rb:17
...
# @api private
#
# pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:6
class GraphQL::Execution::Interpreter::Runtime
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:38
  def initialize(query:); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:329
  def evaluate_selection(result_name, field_ast_nodes_or_ast_node, selections_result); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:377
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:437
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:291
  def evaluate_selections(gathered_selections, selections_result, target_result, runtime_state); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:58
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:67
  def run_eager; end

  # @return [Class<GraphQL::Schema>]
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:33
  def schema; end
...
class GraphQL::Execution::Interpreter::Runtime::CurrentState
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:13
  def initialize; end
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime.rb:21
...
# pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:7
module GraphQL::Execution::Interpreter::Runtime::GraphQLResult
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:8
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:28
  def base_path=(_arg0); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:34
  def build_path(path_array); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:45
  def depth; end
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:53
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:58
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:30
  def path; end
end

# pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:175
class GraphQL::Execution::Interpreter::Runtime::GraphQLResultArray
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:178
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:221
  def [](idx); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:183
  def graphql_skip_at(index); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:205
  def set_child_result(idx, value); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:195
  def set_leaf(idx, value); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:217
  def values; end
end

# pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:61
class GraphQL::Execution::Interpreter::Runtime::GraphQLResultHash
  include ::GraphQL::Execution::Interpreter::Runtime::GraphQLResult

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:62
  def initialize(_result_name, _result_type, _application_value, _parent_result, _is_non_null_in_parent, _selections, _is_eager, _ast_node, _graphql_arguments, graphql_field); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:134
  def [](k); end

  # hook for breadth-first implementations to signal when collecting results.
  #
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:170
  ...
  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:122
  def each; end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:161
  def fix_result_order; end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:72
  def graphql_merged_into; end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:72
  def graphql_merged_into=(_arg0); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:130
  def key?(k); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:138
  def merge_into(into_result); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:68
  def ordered_result_keys; end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:68
  def ordered_result_keys=(_arg0); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:100
  def set_child_result(key, value); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:74
  def set_leaf(key, value); end

  # pkg:gem/graphql#lib/graphql/execution/interpreter/runtime/graphql_result.rb:126
  def values; end
end
...
class GraphQL::Execution::Lazy
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/execution/lazy.rb:57
    def all(lazies); end
  end
end
...
class GraphQL::Execution::Lazy::LazyMethodMap
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/lazy/lazy_method_map.rb:29
...
# pkg:gem/graphql#lib/graphql/execution/load_argument_step.rb:4
class GraphQL::Execution::LoadArgumentStep
  # pkg:gem/graphql#lib/graphql/execution/load_argument_step.rb:5
  def initialize(field_resolve_step:, arguments:, load_receiver:, argument_value:, argument_definition:, argument_key:); end

  # pkg:gem/graphql#lib/graphql/execution/load_argument_step.rb:42
  def call; end

  # pkg:gem/graphql#lib/graphql/execution/load_argument_step.rb:16
  def value; end

  private

  # pkg:gem/graphql#lib/graphql/execution/load_argument_step.rb:77
  def assign_value; end
end
...
class GraphQL::Execution::Lookahead
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:147
  def alias_selection(alias_name, selected_type: T.unsafe(nil), arguments: T.unsafe(nil)); end

  # @return [Hash<Symbol, Object>]
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:53
  def arguments; end

  # @return [Array<GraphQL::Language::Nodes::Field>]
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:44
  def ast_nodes; end

  # @return [GraphQL::Schema::Field]
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:47
  def field; end

  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:216
  def inspect; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:50
  def owner_type; end

  # @return [Boolean] True if this lookahead represents a field that was requested
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:107
  def selected?; end
  ...
  # @return [GraphQL::Execution::Lookahead]
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:115
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:181
  ...
  # @return [Boolean]
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:86
...
#
# pkg:gem/graphql#lib/graphql/execution/lookahead.rb:221
class GraphQL::Execution::Lookahead::NullLookahead < ::GraphQL::Execution::Lookahead
  # No inputs required here.
  #
  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:223
  def initialize; end

  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:242
  def inspect; end

  # pkg:gem/graphql#lib/graphql/execution/lookahead.rb:226
  def selected?; end
...
class GraphQL::Execution::Multiplex
  ...
  # pkg:gem/graphql#lib/graphql/execution/multiplex.rb:42
  def logger; end
...
# pkg:gem/graphql#lib/graphql/execution/next.rb:39
module GraphQL::Execution::Next
  class << self
    # pkg:gem/graphql#lib/graphql/execution/next.rb:79
    def run_all(schema, query_options, context: T.unsafe(nil), max_complexity: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/execution/next.rb:74
    def use(schema, as_default: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/execution/next.rb:40
module GraphQL::Execution::Next::SchemaExtension
  # pkg:gem/graphql#lib/graphql/execution/next.rb:41
  def execute_next(query_str = T.unsafe(nil), query: T.unsafe(nil), subscription_topic: T.unsafe(nil), context: T.unsafe(nil), document: T.unsafe(nil), operation_name: T.unsafe(nil), variables: T.unsafe(nil), warden: T.unsafe(nil), root_value: T.unsafe(nil), validate: T.unsafe(nil), visibility_profile: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/execution/next.rb:69
  def multiplex_next(query_options, context: T.unsafe(nil), max_complexity: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/execution/next.rb:33
module GraphQL::Execution::PostProcessor
  # pkg:gem/graphql#lib/graphql/execution/next.rb:34
  def after_resolve(field_results); end
end

# pkg:gem/graphql#lib/graphql/execution/prepare_object_step.rb:4
class GraphQL::Execution::PrepareObjectStep
  # pkg:gem/graphql#lib/graphql/execution/prepare_object_step.rb:5
...
# pkg:gem/graphql#lib/graphql/execution/resolve_type_step.rb:4
class GraphQL::Execution::ResolveTypeStep
  class << self
    # pkg:gem/graphql#lib/graphql/execution/resolve_type_step.rb:17
    def assert_valid_resolved_type(abstract_type, resolved_type, object, field_resolution_step, query: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/execution/resolve_type_step.rb:5
    def resolve_type(type, object, query); end
  end
end

# pkg:gem/graphql#lib/graphql/execution/runner.rb:4
class GraphQL::Execution::Runner
  # pkg:gem/graphql#lib/graphql/execution/runner.rb:5
  def initialize(multiplex); end

  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/execution/runner.rb:59
  def add_finalizer(query, result_value, key, finalizer); end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:52
  def add_step(step); end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:56
  def authorizes; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:42
  def authorizes?(graphql_definition, query_context); end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:56
  def dataloader; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:75
  def execute; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:40
  def finalizer_keys; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:56
  def finalizers; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:163
  ...
  # pkg:gem/graphql#lib/graphql/execution/runner.rb:206
  def lazy?(object); end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:56
  def resolves_lazies; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:40
  def runtime_directives; end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:56
  def runtime_type_at; end
  ...
  # pkg:gem/graphql#lib/graphql/execution/runner.rb:215
  def type_condition_applies?(context, concrete_type, type_name); end

  # pkg:gem/graphql#lib/graphql/execution/runner.rb:40
  def uses_runtime_directives; end
...
# @api private
#
# pkg:gem/graphql#lib/graphql/execution.rb:13
class GraphQL::Execution::Skip < ::GraphQL::RuntimeError
  # pkg:gem/graphql#lib/graphql/execution.rb:15
  def ast_nodes=(_ignored); end

  # pkg:gem/graphql#lib/graphql/execution.rb:17
  def finalize_graphql_result(query, result_data, key); end

  # pkg:gem/graphql#lib/graphql/execution.rb:14
  def path; end
...
class GraphQL::ExecutionError < ::GraphQL::RuntimeError
  # pkg:gem/graphql#lib/graphql/execution_error.rb:21
  def initialize(message, ast_node: T.unsafe(nil), ast_nodes: T.unsafe(nil), options: T.unsafe(nil), extensions: T.unsafe(nil)); end

  # @return [Hash] Optional custom data for error objects which will be added
  # under the `extensions` key.
  #
  # pkg:gem/graphql#lib/graphql/execution_error.rb:19
  def extensions; end
  ...
  # pkg:gem/graphql#lib/graphql/execution_error.rb:28
  def finalize_graphql_result(query, result_data, key); end
  ...
  # `extensions` key.
  #
  # pkg:gem/graphql#lib/graphql/execution_error.rb:15
  def options; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/execution_error.rb:9
  def path; end
...
class GraphQL::IntegerDecodingError < ::GraphQL::RuntimeTypeError
  ...
  #
  # pkg:gem/graphql#lib/graphql/integer_decoding_error.rb:10
...
class GraphQL::IntegerEncodingError < ::GraphQL::RuntimeTypeError
  ...
  #
  # pkg:gem/graphql#lib/graphql/integer_encoding_error.rb:16
  def field; end

  # The value which couldn't be encoded
  #
  # pkg:gem/graphql#lib/graphql/integer_encoding_error.rb:13
  def integer_value; end

  # @return [Array<String, Integer>] Where the field appeared in the GraphQL response
  #
  # pkg:gem/graphql#lib/graphql/integer_encoding_error.rb:19
  def path; end
end

# pkg:gem/graphql#lib/graphql/introspection.rb:3
module GraphQL::Introspection
  class << self
    # pkg:gem/graphql#lib/graphql/introspection.rb:4
...
# pkg:gem/graphql#lib/graphql/introspection/base_object.rb:4
class GraphQL::Introspection::BaseObject < ::GraphQL::Schema::Object
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/introspection/base_object.rb:7
    def field(*args, **kwargs, &block); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/directive_location_enum.rb:4
...
# pkg:gem/graphql#lib/graphql/introspection/directive_type.rb:4
class GraphQL::Introspection::DirectiveType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/directive_type.rb:30
  def args(include_deprecated:); end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/directive_type.rb:24
    def resolve_args(object, context, include_deprecated:); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/dynamic_fields.rb:4
class GraphQL::Introspection::DynamicFields < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/dynamic_fields.rb:7
  def __typename; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/dynamic_fields.rb:11
    def __typename(object, context); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/entry_points.rb:4
class GraphQL::Introspection::EntryPoints < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/entry_points.rb:17
  def __schema; end

  # pkg:gem/graphql#lib/graphql/introspection/entry_points.rb:21
  def __type(name:); end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/entry_points.rb:10
    def __schema(context); end

    # pkg:gem/graphql#lib/graphql/introspection/entry_points.rb:25
    def __type(context, name:); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/enum_value_type.rb:4
class GraphQL::Introspection::EnumValueType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/enum_value_type.rb:18
  def is_deprecated; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/enum_value_type.rb:14
    def resolve_is_deprecated(object, context); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/field_type.rb:4
class GraphQL::Introspection::FieldType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/field_type.rb:31
  def args(include_deprecated:); end

  # pkg:gem/graphql#lib/graphql/introspection/field_type.rb:21
  def is_deprecated; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/field_type.rb:25
    def resolve_args(object, context, include_deprecated:); end

    # pkg:gem/graphql#lib/graphql/introspection/field_type.rb:17
    def resolve_is_deprecated(object, _context); end
  end
end
...
# pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:4
class GraphQL::Introspection::InputValueType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:44
  def default_value; end

  # pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:20
  def is_deprecated; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:24
    def resolve_default_value(object, context); end

    # pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:16
    def resolve_is_deprecated(object, context); end

    # Recursively serialize, taking care not to add quotes to enum values
    #
    # pkg:gem/graphql#lib/graphql/introspection/input_value_type.rb:52
    def serialize_default_value(value, type, context); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:5
class GraphQL::Introspection::SchemaType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:45
  def directives; end

  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:37
  def mutation_type; end

  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:33
  def query_type; end

  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:22
  def schema_description; end

  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:41
  def subscription_type; end

  # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:26
  def types; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/schema_type.rb:18
    def schema_description(context); end
  end
end

# pkg:gem/graphql#lib/graphql/introspection/type_kind_enum.rb:4
...
# pkg:gem/graphql#lib/graphql/introspection/type_type.rb:4
class GraphQL::Introspection::TypeType < ::GraphQL::Introspection::BaseObject
  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:77
  def enum_values(include_deprecated:); end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:131
  def fields(include_deprecated:); end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:103
  def input_fields(include_deprecated:); end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:89
  def interfaces; end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:39
  def is_one_of; end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:59
  def kind; end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:139
  def of_type; end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:115
  def possible_types; end

  # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:51
  def specified_by_url; end

  class << self
    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:63
    def resolve_enum_values(object, context, include_deprecated:); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:119
    def resolve_fields(object, context, include_deprecated:); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:93
    def resolve_input_fields(object, context, include_deprecated:); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:81
    def resolve_interfaces(object, context); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:34
    def resolve_is_one_of(object, _ctx); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:55
    def resolve_kind(object, context); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:135
    def resolve_of_type(object, _ctx); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:107
    def resolve_possible_types(object, context); end

    # pkg:gem/graphql#lib/graphql/introspection/type_type.rb:43
    def resolve_specified_by_url(object, _ctx); end
  end
end

# pkg:gem/graphql#lib/graphql/invalid_name_error.rb:3
class GraphQL::InvalidNameError < ::GraphQL::Error
...
class GraphQL::InvalidNullError < ::GraphQL::RuntimeError
  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:24
  def initialize(parent_type, field, ast_node_or_nodes, is_from_array: T.unsafe(nil), path: T.unsafe(nil)); end

  # @return [GraphQL::Language::Nodes::Field] the field where the error occurred
  #
  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:13
  def ast_node; end

  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:17
  def ast_nodes; end

  # @return [GraphQL::Field] The field which failed to return a value
  #
  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:10
  def field; end

  # @return [Boolean] indicates an array result caused the error
  #
  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:20
  def is_from_array; end

  # @return [GraphQL::BaseType] The owner of {#field}
  #
  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:7
  def parent_type; end

  # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:22
  def path; end
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:50
    def inspect; end

    # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:42
    def parent_class; end

    # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:42
    def parent_class=(_arg0); end

    # pkg:gem/graphql#lib/graphql/invalid_null_error.rb:44
...
#
# pkg:gem/graphql#lib/graphql.rb:26
class GraphQL::InvariantError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql.rb:27
  def initialize(message); end
end

# pkg:gem/graphql#lib/graphql/language/block_string.rb:3
module GraphQL::Language
  class << self
    # pkg:gem/graphql#lib/graphql/language.rb:105
    ...
    # @return [String]
    #
    # pkg:gem/graphql#lib/graphql/language.rb:47
    def escape_single_quoted_newlines(query_str); end

    # @api private
    #
    # pkg:gem/graphql#lib/graphql/language.rb:20
    def serialize(value); end
  end
end

# pkg:gem/graphql#lib/graphql/language/block_string.rb:4
module GraphQL::Language::BlockString
  class << self
    # pkg:gem/graphql#lib/graphql/language/block_string.rb:94
    def break_line(line, length); end

    # pkg:gem/graphql#lib/graphql/language/block_string.rb:110
    def contains_only_whitespace?(line); end

    # pkg:gem/graphql#lib/graphql/language/block_string.rb:61
    ...
    #
    # pkg:gem/graphql#lib/graphql/language/block_string.rb:7
...
module GraphQL::Language::Comment
  class << self
    # pkg:gem/graphql#lib/graphql/language/comment.rb:5
    def print(str, indent: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/language/definition_slice.rb:4
module GraphQL::Language::DefinitionSlice
  extend ::GraphQL::Language::DefinitionSlice

  # pkg:gem/graphql#lib/graphql/language/definition_slice.rb:7
...
class GraphQL::Language::DefinitionSlice::DependencyVisitor < ::GraphQL::Language::StaticVisitor
  ...
  # pkg:gem/graphql#lib/graphql/language/definition_slice.rb:25
  def on_fragment_spread(node, parent); end

  class << self
    # pkg:gem/graphql#lib/graphql/language/definition_slice.rb:32
...
class GraphQL::Language::DocumentFromSchemaDefinition
  ...
  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:133
  def build_argument_node(argument); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:250
  def build_argument_nodes(arguments); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:198
  def build_default_value(default_value, type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:266
  ...
  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:260
  def build_directive_nodes(directives); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:103
  def build_enum_type_node(enum_type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:115
  def build_enum_value_node(enum_value); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:71
  def build_field_node(field); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:325
  def build_field_nodes(fields); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:152
  def build_input_object_node(input_object); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:92
  def build_interface_type_node(interface_type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:53
  def build_object_type_node(object_type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:124
  def build_scalar_type_node(scalar_type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:38
  def build_schema_node; end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:231
  def build_type_definition_node(type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:313
  ...
  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:82
  def build_union_type_node(union_type); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:32
  def document; end

  private

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:383
  def always_include_schema; end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:349
  def definition_directives(member, directives_method); end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:345
  ...
  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:333
  def include_schema_node?; end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:383
  def schema; end

  # pkg:gem/graphql#lib/graphql/language/document_from_schema_definition.rb:339
  def schema_respects_root_name_conventions?(schema); end
end

# pkg:gem/graphql#lib/graphql/language.rb:93
GraphQL::Language::EFFICIENT_IGNORE_REGEXP = T.let(T.unsafe(nil), Regexp)
...
#
# pkg:gem/graphql#lib/graphql/language.rb:92
GraphQL::Language::EFFICIENT_NUMBER_REGEXP = T.let(T.unsafe(nil), Regexp)

# Exposes {.generate}, which turns AST nodes back into query strings.
#
# pkg:gem/graphql#lib/graphql/language/generation.rb:5
module GraphQL::Language::Generation
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/generation.rb:19
  def generate(node, indent: T.unsafe(nil), printer: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/language.rb:97
GraphQL::Language::INVALID_NUMBER_FOLLOWED_BY_NAME_REGEXP = T.let(T.unsafe(nil), Regexp)

# pkg:gem/graphql#lib/graphql/language.rb:86
GraphQL::Language::LEADING_REGEX = T.let(T.unsafe(nil), Regexp)

# pkg:gem/graphql#lib/graphql/language/lexer.rb:5
class GraphQL::Language::Lexer
  # pkg:gem/graphql#lib/graphql/language/lexer.rb:6
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/lexer.rb:258
  def _hash(key); end
  ...
  # pkg:gem/graphql#lib/graphql/language/lexer.rb:185
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/language/lexer.rb:339
    ...
    #
    # pkg:gem/graphql#lib/graphql/language/lexer.rb:366
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:312
...
# int or float
#
# pkg:gem/graphql#lib/graphql/language/lexer.rb:314
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:190
...
#
# pkg:gem/graphql#lib/graphql/language/lexer.rb:310
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:288
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:189
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:221
GraphQL::Language::Lexer::KEYWORD_BY_TWO_BYTES = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/language/lexer.rb:220
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:262
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:263
...
# pkg:gem/graphql#lib/graphql/language/lexer.rb:287
...
GraphQL::Language::MAYBE_INVALID_NUMBER = T.let(T.unsafe(nil), Regexp)

# pkg:gem/graphql#lib/graphql/language/nodes.rb:4
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:12
class GraphQL::Language::Nodes::AbstractNode
  # Value equality
  # @return [Boolean] True if `self` is equivalent to `other`
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:50
  def ==(other); end

  # @return [Array<GraphQL::Language::Nodes::AbstractNode>] all nodes in the tree below this one
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:60
  def children; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:76
  def children_method_name; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:40
  def col; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:44
  def definition_line; end

  # TODO DRY with `replace_child`
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:126
  def delete_child(previous_child); end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:34
  def filename; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:36
  def line; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:99
  def merge(new_options); end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:80
  def position; end

  # Copy `self`, but modify the copy so that `previous_child` is replaced by `new_child`
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:104
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:65
  def scalars; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:84
  def to_query_string(printer: T.unsafe(nil)); end

  protected

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:140
  def merge!(new_options); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:70
  def initialize_copy(other); end

  class << self
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:174
    def children_of_type; end

    # Add a default `#visit_method` and `#children_method_name` using the class name
    #
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:151
    ...
    #
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:185
    def children_methods(children_of_type); end

    # pkg:gem/graphql#lib/graphql/language/nodes.rb:284
    ...
    #
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:252
    def scalar_methods(*method_names); end
  end
end

# pkg:gem/graphql#lib/graphql/language/nodes.rb:14
module GraphQL::Language::Nodes::AbstractNode::DefinitionNode
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:19
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:24
  def marshal_dump; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:28
  def marshal_load(values); end
end

# pkg:gem/graphql#lib/graphql/language/nodes.rb:57
GraphQL::Language::Nodes::AbstractNode::NO_CHILDREN = T.let(T.unsafe(nil), Array)

# A key-value pair for a field's inputs
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:369
class GraphQL::Language::Nodes::Argument < ::GraphQL::Language::Nodes::AbstractNode
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:324
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:379
  def children; end
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:263
  def name; end
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:158
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:384
class GraphQL::Language::Nodes::Directive < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:216
  def children; end
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:205
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:392
class GraphQL::Language::Nodes::DirectiveDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:220
  def children; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:393
  def description; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:389
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:616
class GraphQL::Language::Nodes::Document < ::GraphQL::Language::Nodes::AbstractNode
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:622
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:765
class GraphQL::Language::Nodes::EnumTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:766
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:775
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:756
class GraphQL::Language::Nodes::EnumValueDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:757
  def comment; end
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:411
class GraphQL::Language::Nodes::Field < ::GraphQL::Language::Nodes::AbstractNode
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:412
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:430
  def marshal_dump; end

  # pkg:gem/graphql#lib/graphql/language/nodes.rb:434
  def marshal_load(values); end
  ...
  class << self
    ...
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:426
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:678
class GraphQL::Language::Nodes::FieldDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:679
  def comment; end
  ...
  # with `#replace_child`
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:689
  def fields; end
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:690
  def merge(new_options); end
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:450
class GraphQL::Language::Nodes::FragmentDefinition < ::GraphQL::Language::Nodes::AbstractNode
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:451
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:471
  def marshal_load(values); end
  ...
  class << self
    ...
    # pkg:gem/graphql#lib/graphql/language/nodes.rb:463
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:485
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:496
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:510
class GraphQL::Language::Nodes::InputObject < ::GraphQL::Language::Nodes::AbstractNode
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:518
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:530
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:784
class GraphQL::Language::Nodes::InputObjectTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:785
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:794
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:669
class GraphQL::Language::Nodes::InputValueDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:670
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:717
class GraphQL::Language::Nodes::InterfaceTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:718
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:728
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:549
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:5
GraphQL::Language::Nodes::NONE = T.let(T.unsafe(nil), Array)

# Base class for nodes whose only value is a name (no child nodes or other scalars)
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:363
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:407
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:698
class GraphQL::Language::Nodes::ObjectTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:699
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:708
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:575
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:652
class GraphQL::Language::Nodes::ScalarTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:653
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:661
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:636
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:644
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:738
class GraphQL::Language::Nodes::UnionTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:739
  def comment; end
...
# pkg:gem/graphql#lib/graphql/language/nodes.rb:747
class GraphQL::Language::Nodes::UnionTypeExtension < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # pkg:gem/graphql#lib/graphql/language/nodes.rb:748
  def types; end
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:557
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:632
...
#
# pkg:gem/graphql#lib/graphql/language/nodes.rb:357
...
# pkg:gem/graphql#lib/graphql/language/parser.rb:9
class GraphQL::Language::Parser
  include ::GraphQL::Language::Nodes
  include ::GraphQL::EmptyObjects

  # pkg:gem/graphql#lib/graphql/language/parser.rb:31
  def initialize(graphql_str, filename: T.unsafe(nil), trace: T.unsafe(nil), max_tokens: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:67
  def column_at(pos); end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:58
  def line_at(pos); end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:43
  def parse; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:53
  def tokens_count; end

  private

  # pkg:gem/graphql#lib/graphql/language/parser.rb:97
  def advance_token; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:803
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/parser.rb:842
  def debug_token_value; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:120
  def definition; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:105
  def document; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:814
  def expect_one_of(token_names); end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:807
  def expect_token(expected_token_name); end

  # Only use when we care about the expected token's value
  #
  # pkg:gem/graphql#lib/graphql/language/parser.rb:831
  def expect_token_value(tok); end

  # @return [Array<Integer>] Positions of each line break in the original string
  #
  # pkg:gem/graphql#lib/graphql/language/parser.rb:80
  def lines_at; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:508
  def list_type; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:460
  def parse_argument_definitions; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:681
  def parse_arguments; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:664
  def parse_directives; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:385
  def parse_enum_value_definitions; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:441
  def parse_field_definitions; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:426
  def parse_implements; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:371
  def parse_input_object_field_definitions; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:474
  def parse_input_value_definition; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:586
  def parse_name; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:652
  def parse_name_without_on; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:521
  def parse_operation_type; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:660
  def parse_type_name; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:409
  def parse_union_members; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:101
  def pos; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:818
  def raise_parse_error(message); end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:535
  def selection_set; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:701
  def string_value; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:95
  def token_name; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:491
  def type; end

  # pkg:gem/graphql#lib/graphql/language/parser.rb:707
  def value; end

  class << self
    # pkg:gem/graphql#lib/graphql/language/parser.rb:14
    def cache; end

    # pkg:gem/graphql#lib/graphql/language/parser.rb:14
    def cache=(_arg0); end

    # pkg:gem/graphql#lib/graphql/language/parser.rb:16
    def parse(graphql_str, filename: T.unsafe(nil), trace: T.unsafe(nil), max_tokens: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/language/parser.rb:20
    def parse_file(filename, trace: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/language/parser.rb:845
class GraphQL::Language::Parser::SchemaParser < ::GraphQL::Language::Parser
  # pkg:gem/graphql#lib/graphql/language/parser.rb:846
  def initialize(*args, **kwargs); end
end

# pkg:gem/graphql#lib/graphql/language/printer.rb:4
class GraphQL::Language::Printer
  ...
  # @return [String] Valid GraphQL for `node`
  #
  # pkg:gem/graphql#lib/graphql/language/printer.rb:54
  def print(node, indent: T.unsafe(nil), truncate_size: T.unsafe(nil)); end

  protected

  # pkg:gem/graphql#lib/graphql/language/printer.rb:76
  def print_argument(argument); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:296
  def print_arguments(arguments, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:430
  def print_comment(node, indent: T.unsafe(nil), first_in_block: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:423
  def print_description(node, indent: T.unsafe(nil), first_in_block: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:437
  def print_description_and_comment(node); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:91
  def print_directive(directive); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:399
  def print_directive_definition(directive); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:458
  def print_directives(directives); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:69
  def print_document(document); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:105
  def print_enum(enum); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:358
  def print_enum_type_definition(enum_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:374
  def print_enum_value_definition(enum_value); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:113
  def print_field(field, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:321
  def print_field_definition(field); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:442
  def print_field_definitions(fields); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:132
  def print_fragment_definition(fragment_def, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:148
  def print_fragment_spread(fragment_spread, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:273
  def print_implements(type); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:155
  def print_inline_fragment(inline_fragment, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:82
  def print_input_object(input_object); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:381
  def print_input_object_type_definition(input_object_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:285
  def print_input_value_definition(input_value); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:331
  def print_interface_type_definition(interface_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:166
  def print_list_type(list_type); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:479
  def print_node(node, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:172
  def print_non_null_type(non_null_type); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:109
  def print_null_value; end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:264
  def print_object_type_definition(object_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:177
  def print_operation_definition(operation_definition, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:257
  def print_scalar_type_definition(scalar_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:222
  def print_schema_definition(schema, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:467
  def print_selections(selections, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:65
  def print_string(str); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:198
  def print_type_name(type_name); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:340
  def print_union_type_definition(union_type, extension: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:202
  def print_variable_definition(variable_definition); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:217
  def print_variable_identifier(variable_identifier); end
end

# pkg:gem/graphql#lib/graphql/language/printer.rb:5
GraphQL::Language::Printer::OMISSION = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/language/printer.rb:7
class GraphQL::Language::Printer::TruncatableBuffer
  # pkg:gem/graphql#lib/graphql/language/printer.rb:12
  def initialize(truncate_size: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:17
  def append(other); end

  # pkg:gem/graphql#lib/graphql/language/printer.rb:26
  def to_string; end
end

# pkg:gem/graphql#lib/graphql/language/printer.rb:10
GraphQL::Language::Printer::TruncatableBuffer::DEFAULT_INIT_CAPACITY = T.let(T.unsafe(nil), Integer)

# pkg:gem/graphql#lib/graphql/language/printer.rb:8
...
class GraphQL::Language::SanitizedPrinter < ::GraphQL::Language::Printer
  ...
  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:75
  def print_argument(argument); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:144
  def print_directive(directive); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:115
  def print_field(field, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:135
  def print_fragment_definition(fragment_def, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:123
  def print_inline_fragment(inline_fragment, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:39
  def print_node(node, indent: T.unsafe(nil)); end

  # Print the operation definition but do not include the variable
  # definitions since we will inline them within the query
  #
  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:154
  def print_operation_definition(operation_definition, indent: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:106
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:63
  ...
  # string "<REDACTED>".
  #
  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:71
  def redacted_argument_value(argument); end

  # @return [String, nil] A scrubbed query string, if the query was valid.
  #
  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:31
  def sanitized_query_string; end

  private

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:217
  def query; end

  # pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:172
  def value_to_ast(value, type); end
end

# pkg:gem/graphql#lib/graphql/language/sanitized_printer.rb:20
...
#
# pkg:gem/graphql#lib/graphql/language/static_visitor.rb:6
class GraphQL::Language::StaticVisitor
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:7
  def initialize(document); end

  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:101
  def on_argument(node, parent); end

  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:76
  ...
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:25
  ...
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:32
  ...
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:61
  ...
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:66
  ...
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:68
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:13
  def visit; end

  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:40
  def visit_directives(new_node); end

  # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:46
  def visit_selections(new_node); end

  class << self
    # We don't use `alias` here because it breaks `super`
    #
    # pkg:gem/graphql#lib/graphql/language/static_visitor.rb:96
...
#
# pkg:gem/graphql#lib/graphql/language/visitor.rb:35
class GraphQL::Language::Visitor
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:42
  def initialize(document); end

  # pkg:gem/graphql#lib/graphql/language/visitor.rb:172
  def on_argument(node, parent); end

  # pkg:gem/graphql#lib/graphql/language/visitor.rb:142
  def on_argument_children(new_node); end
  ...
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:64
  def on_document_children(document_node); end
  ...
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:77
  def on_field_children(new_node); end
  ...
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:121
  def on_fragment_definition_children(new_node); end
  ...
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:127
  def on_inline_fragment_children(new_node); end
  ...
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:129
  def on_operation_definition_children(new_node); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:48
  def result; end

  # Visit `document` and all children
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/language/visitor.rb:52
  def visit; end

  # pkg:gem/graphql#lib/graphql/language/visitor.rb:90
  def visit_directives(new_node); end

  # pkg:gem/graphql#lib/graphql/language/visitor.rb:101
  def visit_selections(new_node); end

  private

  # pkg:gem/graphql#lib/graphql/language/visitor.rb:265
  def apply_modifications(node, parent, new_node_and_new_parent); end

  class << self
    # We don't use `alias` here because it breaks `super`
    #
    # pkg:gem/graphql#lib/graphql/language/visitor.rb:167
    def make_visit_methods(ast_node_class); end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/language/visitor.rb:40
GraphQL::Language::Visitor::DELETE_NODE = T.let(T.unsafe(nil), GraphQL::Language::Visitor::DeleteNode)

# pkg:gem/graphql#lib/graphql/language/visitor.rb:36
...
class GraphQL::LoadApplicationObjectFailedError < ::GraphQL::ExecutionError
  # pkg:gem/graphql#lib/graphql/load_application_object_failed_error.rb:18
  ...
  #
  # pkg:gem/graphql#lib/graphql/load_application_object_failed_error.rb:10
  def argument; end

  # @return [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/load_application_object_failed_error.rb:16
  def context; end

  # @return [String] The ID provided by the client
  #
  # pkg:gem/graphql#lib/graphql/load_application_object_failed_error.rb:12
  def id; end

  # @return [Object] The value found with this ID
  #
  # pkg:gem/graphql#lib/graphql/load_application_object_failed_error.rb:14
  def object; end
end

# pkg:gem/graphql#lib/graphql.rb:75
...
# pkg:gem/graphql#lib/graphql/name_validator.rb:4
GraphQL::NameValidator::VALID_NAME_REGEX = T.let(T.unsafe(nil), Regexp)

# pkg:gem/graphql#lib/graphql/pagination/connection.rb:4
module GraphQL::Pagination; end

# Customizes `RelationConnection` to work with `ActiveRecord::Relation`s.
#
# pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:7
class GraphQL::Pagination::ActiveRecordRelationConnection < ::GraphQL::Pagination::RelationConnection
  ...
  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:43
  def null_relation(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:10
  def relation_count(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:27
  def relation_limit(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:35
  def relation_offset(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:52
  def set_limit(nodes, limit); end

  # pkg:gem/graphql#lib/graphql/pagination/active_record_relation_connection.rb:60
  def set_offset(nodes, offset); end
end

# pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:6
class GraphQL::Pagination::ArrayConnection < ::GraphQL::Pagination::Connection
  # pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:22
  def cursor_for(item); end

  # pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:17
  def has_next_page; end

  # pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:12
  def has_previous_page; end

  # pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:7
  def nodes; end

  private

  # pkg:gem/graphql#lib/graphql/pagination/array_connection.rb:29
...
class GraphQL::Pagination::Connection
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:69
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:48
  def after; end

  # Raw access to client-provided values. (`max_page_size` not applied to first or last.)
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:36
  def after_value; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:57
  def arguments; end
  ...
  # @return [String, nil] the client-provided cursor. `""` is treated as `nil`.
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:39
  def before; end
  ...
  # @return [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:22
  def context; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:24
  ...
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:220
  def cursor_for(item); end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:125
  def default_page_size; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:120
  def default_page_size=(new_value); end

  # @return [Class] A wrapper class for edges of this connection
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:176
  def edge_class; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:171
  def edges; end

  # @return [String] The cursor of the last item in {nodes}
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:213
  def end_cursor; end

  # @return [GraphQL::Schema::Field] The field this connection was returned by
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:179
  def field; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:145
  def first; end
  ...
  #   `max_page_size`. If `default_page_size` is nil, use `max_page_size`.
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:137
  def first=(_arg0); end
  ...
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:108
  def max_page_size; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:103
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:182
  def nodes; end

  # The connection object itself implements `PageInfo` fields
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:193
  def page_info; end

  # @return [Object] the object this collection belongs to
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:33
  def parent; end
  ...
  # @return [Edge]
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:160
  def range_add_edge(item); end

  # @return [String] The cursor of the first item in {nodes}
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:208
  def start_cursor; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:97
  def was_authorized_by_scope_items=(_arg0); end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:99
  def was_authorized_by_scope_items?; end

  private

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:250
  def decode(cursor); end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:226
  def detect_was_authorized_by_scope_items; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:254
  ...
  #
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:239
...
#
# pkg:gem/graphql#lib/graphql/pagination/connection.rb:260
class GraphQL::Pagination::Connection::Edge
  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:263
  def initialize(node, connection); end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:272
  def cursor; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:261
  def node; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:268
  def parent; end

  # pkg:gem/graphql#lib/graphql/pagination/connection.rb:276
  def was_authorized_by_scope_items?; end
end

# pkg:gem/graphql#lib/graphql/pagination/connection.rb:15
...
class GraphQL::Pagination::Connections
  ...
  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:30
  def add(nodes_class, implementation); end

  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:38
  def all_wrappers; end

  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:34
  def delete(nodes_class); end

  # use an override if there is one
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:118
  def edge_class_for_field(field); end

  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:86
  def populate_connection(field, object, value, original_arguments, context); end
  ...
  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:48
  def wrapper_for(items, wrappers: T.unsafe(nil)); end

  protected

  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:129
  def wrappers; end

  private

  # pkg:gem/graphql#lib/graphql/pagination/connections.rb:133
  def add_default; end
end

# pkg:gem/graphql#lib/graphql/pagination/connections.rb:21
class GraphQL::Pagination::Connections::ImplementationMissingError < ::GraphQL::Error; end

# pkg:gem/graphql#lib/graphql/pagination/mongoid_relation_connection.rb:6
class GraphQL::Pagination::MongoidRelationConnection < ::GraphQL::Pagination::RelationConnection
  # pkg:gem/graphql#lib/graphql/pagination/mongoid_relation_connection.rb:19
  def null_relation(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/mongoid_relation_connection.rb:15
  def relation_count(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/mongoid_relation_connection.rb:11
  def relation_limit(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/mongoid_relation_connection.rb:7
  def relation_offset(relation); end
end
...
#
# pkg:gem/graphql#lib/graphql/pagination/sequel_dataset_connection.rb:7
class GraphQL::Pagination::SequelDatasetConnection < ::GraphQL::Pagination::RelationConnection
  private

  # pkg:gem/graphql#lib/graphql/pagination/sequel_dataset_connection.rb:23
  def null_relation(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/sequel_dataset_connection.rb:18
  def relation_count(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/sequel_dataset_connection.rb:14
  def relation_limit(relation); end

  # pkg:gem/graphql#lib/graphql/pagination/sequel_dataset_connection.rb:10
  def relation_offset(relation); end
end
...
class GraphQL::ParseError < ::GraphQL::Error
  ...
  # pkg:gem/graphql#lib/graphql/parse_error.rb:16
  def to_h; end
end

# A combination of query string and {Schema} instance which can be reduced to a {#result}.
#
# pkg:gem/graphql#lib/graphql/query.rb:5
class GraphQL::Query
  include ::GraphQL::Tracing::Traceable
  include ::GraphQL::Query::Runnable
  extend ::GraphQL::Autoload
  extend ::Forwardable
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:225
  def current_trace; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:71
  def operation_name; end
  ...
  # pkg:gem/graphql#lib/graphql/query.rb:262
  def operations; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:215
  def query_string; end

  # If a document was provided to `GraphQL::Schema#execute` instead of the raw query string, we will need to get it from the document
  #
  # pkg:gem/graphql#lib/graphql/query.rb:99
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:288
  def result; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query.rb:256
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:68
  def root_value; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:277
  def run_partials(partials_hashes); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:86
  ...
  #
  # pkg:gem/graphql#lib/graphql/query.rb:122
  def subscription_topic; end

  # pkg:gem/graphql#lib/graphql/query.rb:229
...
class GraphQL::Query::Context
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:46
  ...
  # pkg:gem/graphql#lib/graphql/query/context.rb:76
  def []=(key, value); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:121
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:139
  def backtrace; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:147
  def current_path; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:63
  def dataloader; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:161
  def delete(key); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:189
  def dig(key, *other_keys); end

  # @return [Array<GraphQL::ExecutionError>] errors returned during execution
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:35
  def errors; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:143
  def execution_errors; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:171
  def fetch(key, default = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:248
  def inspect; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:68
  def interpreter=(_arg0); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:216
  def key?(key); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:244
  def logger; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:231
  def namespace(ns); end

  # @return [Boolean] true if this namespace was accessed before
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:240
  def namespace?(ns); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:131
  def raw_value(value); end

  # Modify this hash to return extensions to client.
  # @return [Hash] A hash that will be added verbatim to the result hash, as `"extensions" => { ... }`
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:59
  def response_extensions; end

  # @return [GraphQL::Schema]
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:41
  def schema; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:271
  def scoped; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:74
  def scoped_context; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:252
  def scoped_merge!(hash); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:256
  def scoped_set!(key, value); end

  # Return this value to tell the runtime
  # to exclude this field from the response altogether
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:114
  def skip; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:206
  def to_h; end

  # pkg:gem/graphql#lib/graphql/query/context.rb:214
  def to_hash; end
  ...
  # pkg:gem/graphql#lib/graphql/query/context.rb:86
  def types=(_arg0); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:71
  def value=(_arg0); end

  # @return [GraphQL::Schema::Warden]
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:221
  def warden; end

  # @return [GraphQL::Schema::Warden]
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query/context.rb:226
  def warden=(_arg0); end
end

# pkg:gem/graphql#lib/graphql/query/context.rb:9
class GraphQL::Query::Context::ExecutionErrors
  # pkg:gem/graphql#lib/graphql/query/context.rb:10
  def initialize(ctx); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:27
  def >>(err_or_msg); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:14
  def add(err_or_msg); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:28
  def push(err_or_msg); end
end

# pkg:gem/graphql#lib/graphql/query/context.rb:88
GraphQL::Query::Context::RUNTIME_METADATA_KEYS = T.let(T.unsafe(nil), Set)

# pkg:gem/graphql#lib/graphql/query/context.rb:275
class GraphQL::Query::Context::Scoped
  # pkg:gem/graphql#lib/graphql/query/context.rb:276
  def initialize(scoped_context, path); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:281
  def merge!(hash); end

  # pkg:gem/graphql#lib/graphql/query/context.rb:285
  def set!(key, value); end
end

# pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:5
class GraphQL::Query::Context::ScopedContext
  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:6
  def initialize(query_context); end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:46
  def [](key); end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:55
  def current_path; end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:59
  def dig(key, *other_keys); end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:35
  def key?(key); end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:24
  def merge!(hash, at: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:12
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/context/scoped_context.rb:77
  def each_present_path_ctx; end
end

# pkg:gem/graphql#lib/graphql/query/context.rb:169
...
module GraphQL::Query::Fingerprint
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/query/fingerprint.rb:15
...
class GraphQL::Query::InputValidationResult
  ...
  # pkg:gem/graphql#lib/graphql/query/input_validation_result.rb:22
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/query/input_validation_result.rb:7
    def from_problem(explanation, path = T.unsafe(nil), extensions: T.unsafe(nil), message: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/query/input_validation_result.rb:48
...
class GraphQL::Query::NullContext < ::GraphQL::Query::Context
  # pkg:gem/graphql#lib/graphql/query/null_context.rb:29
  ...
  class << self
    ...
    # pkg:gem/graphql#lib/graphql/query/null_context.rb:11
    def instance=(new_inst); end
  end
end

# pkg:gem/graphql#lib/graphql/query/null_context.rb:15
class GraphQL::Query::NullContext::NullQuery
  # pkg:gem/graphql#lib/graphql/query/null_context.rb:16
  def after_lazy(value); end
end

# pkg:gem/graphql#lib/graphql/query/null_context.rb:21
...
class GraphQL::Query::OperationNameMissingError < ::GraphQL::ExecutionError
  # pkg:gem/graphql#lib/graphql/query.rb:55
...
#
# pkg:gem/graphql#lib/graphql/query/partial.rb:14
class GraphQL::Query::Partial
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/partial.rb:22
  def initialize(object:, query:, path: T.unsafe(nil), context: T.unsafe(nil), fragment_node: T.unsafe(nil), type: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:118
  def analysis_errors=(_ignored); end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:114
  def analyzers; end
  ...
  # pkg:gem/graphql#lib/graphql/query/partial.rb:78
  def current_trace; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:59
  def field_definition; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:94
  def fragments; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:51
  def leaf?; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:61
  def multiplex; end
  ...
  # pkg:gem/graphql#lib/graphql/query/partial.rb:106
  def query?; end
  ...
  # pkg:gem/graphql#lib/graphql/query/partial.rb:61
  def result_values=(_arg0); end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:59
  def root_type; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:55
  def root_value; end
  ...
  # pkg:gem/graphql#lib/graphql/query/partial.rb:126
  def selected_operation; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:134
  def selected_operation_name; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:130
  def static_errors; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:122
  def subscription?; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:82
  def types; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:102
  def valid?; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:98
  def validate; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:90
  def variables; end

  private

  # pkg:gem/graphql#lib/graphql/query/partial.rb:140
  def set_type_info_from_path; end
end

# pkg:gem/graphql#lib/graphql/query/partial.rb:63
class GraphQL::Query::Partial::Result < ::GraphQL::Query::Result
  # @return [GraphQL::Query::Partial]
  #
  # pkg:gem/graphql#lib/graphql/query/partial.rb:69
  def partial; end

  # pkg:gem/graphql#lib/graphql/query/partial.rb:64
  def path; end
end
...
#
# pkg:gem/graphql#lib/graphql/query/result.rb:8
class GraphQL::Query::Result
  ...
  # @return [Boolean]
  #
  # pkg:gem/graphql#lib/graphql/query/result.rb:51
  def ==(other); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/result.rb:27
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/result.rb:17
  def query; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/query/result.rb:20
  def to_h; end
...
#
# pkg:gem/graphql#lib/graphql/query.rb:21
module GraphQL::Query::Runnable
  # pkg:gem/graphql#lib/graphql/query.rb:22
  def after_lazy(value, &block); end

  # pkg:gem/graphql#lib/graphql/query.rb:43
  ...
  # @return [Hash{Symbol => Object}]
  #
  # pkg:gem/graphql#lib/graphql/query.rb:39
  def arguments_for(ast_node, definition, parent_object: T.unsafe(nil)); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/query.rb:48
  def handle_or_reraise(err, **kwargs); end
end
...
#
# pkg:gem/graphql#lib/graphql/query/variables.rb:5
class GraphQL::Query::Variables
  ...
  # pkg:gem/graphql#lib/graphql/query/variables.rb:85
  def add_max_errors_reached_message; end

  # pkg:gem/graphql#lib/graphql/query/variables.rb:70
  def deep_stringify(val); end
end

# pkg:gem/graphql#lib/graphql/relay/range_add.rb:3
...
# pkg:gem/graphql#lib/graphql/runtime_error.rb:3
class GraphQL::RuntimeError < ::GraphQL::Error
  include ::GraphQL::Execution::Finalizer
end

# pkg:gem/graphql#lib/graphql/runtime_type_error.rb:3
...
class GraphQL::Schema
  ...
  class << self
    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1663
    ...
    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1728
    ...
    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1688
    def after_lazy(value, &block); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1764
    def allow_legacy_invalid_empty_selections_on_union(new_value = T.unsafe(nil)); end
    ...
    # @return [true, false, nil]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1816
    def allow_legacy_invalid_return_type_conflicts(new_value = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:917
    def analysis_engine; end

    # pkg:gem/graphql#lib/graphql/schema.rb:915
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:269
    ...
    # pkg:gem/graphql#lib/graphql/schema.rb:212
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1868
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1910
    def complexity_cost_calculation_mode_for(multiplex_context); end

    # @api private
    # @return [GraphQL::Pagination::Connections] if installed
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:423
    def connections; end

    # @api private
    # @return [GraphQL::Pagination::Connections] if installed
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:420
    def connections=(_arg0); end

    # @param new_context_class [Class<GraphQL::Query::Context>] A subclass to use when executing queries
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1104
    def context_class(new_context_class = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:945
    def count_introspection_fields; end

    # pkg:gem/graphql#lib/graphql/schema.rb:776
    def cursor_encoder(new_encoder = T.unsafe(nil)); end

    # @api private
    # @see GraphQL::Dataloader
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:679
    def dataloader_class; end

    # @api private
    # @see GraphQL::Dataloader
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:683
    def dataloader_class=(_arg0); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1061
    def default_analysis_engine; end

    # pkg:gem/graphql#lib/graphql/schema.rb:1408
    def default_directives; end

    # pkg:gem/graphql#lib/graphql/schema.rb:1643
    def default_execution_next(new_value = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1053
    def default_execution_strategy; end

    # @param new_default_logger [#log] Something to use for logging messages
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1071
    def default_logger(new_default_logger = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:783
    def default_max_page_size(new_default_max_page_size = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:802
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:152
    def default_trace_mode(new_mode = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:138
    def deprecated_graphql_definition; end

    # @return [String, nil]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:295
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1419
    def detailed_trace; end

    # @return [GraphQL::Tracing::DetailedTrace] if it has been configured for this schema
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1419
    def detailed_trace=(_arg0); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1424
    def detailed_trace?(query); end

    # Returns `DidYouMean` if it's defined.
    # Override this to return `nil` if you don't want to use `DidYouMean`
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1740
    ...
    # @return void
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1400
    def directive(new_directive); end

    # Add several directives at once
    # @param new_directives [Class]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1384
    def directives(*new_directives); end

    # pkg:gem/graphql#lib/graphql/schema.rb:953
    def disable_introspection_entry_points; end

    # pkg:gem/graphql#lib/graphql/schema.rb:971
    def disable_introspection_entry_points?; end

    # pkg:gem/graphql#lib/graphql/schema.rb:959
    def disable_schema_introspection_entry_point; end

    # pkg:gem/graphql#lib/graphql/schema.rb:979
    def disable_schema_introspection_entry_point?; end

    # pkg:gem/graphql#lib/graphql/schema.rb:965
    def disable_type_introspection_entry_point; end

    # pkg:gem/graphql#lib/graphql/schema.rb:987
    def disable_type_introspection_entry_point?; end

    # pkg:gem/graphql#lib/graphql/schema.rb:921
    def error_bubbling(new_error_bubbling = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:930
    def error_bubbling=(_arg0); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1132
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1586
    def execute(query_str = T.unsafe(nil), **kwargs); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1594
    def execute_legacy(query_str = T.unsafe(nil), **kwargs); end

    # @param new_extra_types [Module] Type definitions to include in printing and introspection, even though they aren't referenced in the schema
    # @return [Array<Module>] Type definitions added to this schema
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:997
    def extra_types(*new_extra_types); end

    # pkg:gem/graphql#lib/graphql/schema.rb:305
    def find(path); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:115
    def from_definition(definition_or_path, default_resolve: T.unsafe(nil), parser: T.unsafe(nil), using: T.unsafe(nil), base_types: T.unsafe(nil)); end

    # Create schema with the result of an introspection query.
    # @param introspection_result [Hash] A response from {GraphQL::Introspection::INTROSPECTION_QUERY}
    # @return [Class<GraphQL::Schema>] the schema described by `input`
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:105
    def from_introspection(introspection_result); end

    # pkg:gem/graphql#lib/graphql/schema.rb:710
    def get_field(type_or_name, field_name, context = T.unsafe(nil), use_visibility_profile = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:747
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:375
    def get_type(type_name, context = T.unsafe(nil), use_visibility_profile = T.unsafe(nil)); end

    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1153
    def handle_or_reraise(context, err, object: T.unsafe(nil), arguments: T.unsafe(nil), field: T.unsafe(nil)); end

    # @return [Boolean] Does this schema have _any_ definition for a type named `type_name`, regardless of visibility?
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:415
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1267
    def id_from_object(application_object, graphql_type, context); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1218
    def inherited(child_class); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1372
    def instrument(instrument_step, instrumenter, options = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1655
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:754
    def introspection(new_introspection_namespace = T.unsafe(nil)); end

    # @return [Schema::IntrospectionSystem] Based on {introspection}
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:768
    def introspection_system; end

    # @return [Boolean] True if this object should be lazily resolved
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1720
    def lazy?(obj); end

    # @return [Symbol, nil] The method name to lazily resolve `obj`, or nil if `obj`'s class wasn't registered with {.lazy_resolve}.
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1715
    def lazy_method_name(obj); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1358
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1929
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1788
    ...
    # @return [nil] Don't send the client an error, continue the legacy behavior (allow this query to execute)
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1803
    ...
    # @return [nil] Don't send the client an error, continue the legacy behavior (allow this query to execute)
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1844
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1285
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1093
    def logger_for(context); end

    # pkg:gem/graphql#lib/graphql/schema.rb:896
    def max_complexity(max_complexity = T.unsafe(nil), count_introspection_fields: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:894
    def max_complexity=(_arg0); end

    # pkg:gem/graphql#lib/graphql/schema.rb:907
    def max_complexity_count_introspection_fields; end

    # pkg:gem/graphql#lib/graphql/schema.rb:934
    def max_depth(new_max_depth = T.unsafe(nil), count_introspection_fields: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:932
    ...
    # @return [nil, Integer]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:794
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1635
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1567
    def multiplex_analyzer(new_analyzer); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1571
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:485
    def mutation(new_mutation_object = T.unsafe(nil), &lazy_load_block); end

    # pkg:gem/graphql#lib/graphql/schema.rb:822
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1525
    def new_trace(mode: T.unsafe(nil), **options); end

    # pkg:gem/graphql#lib/graphql/schema.rb:335
    def null_context; end

    # pkg:gem/graphql#lib/graphql/schema.rb:333
    def null_context=(_arg0); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1250
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1022
    def orphan_types(*new_orphan_types); end

    # pkg:gem/graphql#lib/graphql/schema.rb:208
    def own_trace_modes; end

    # pkg:gem/graphql#lib/graphql/schema.rb:240
    ...
    # @return void
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1354
    def parse_error(parse_err, ctx); end

    # pkg:gem/graphql#lib/graphql/schema.rb:329
    def plugins; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:626
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:446
    ...
    # @return [void]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1680
    def query_stack_error(query, err); end

    # pkg:gem/graphql#lib/graphql/schema.rb:685
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1126
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1213
    def resolve_type(abstract_type, application_object, context); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1362
    def resolves_lazies?; end

    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:559
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:573
    def root_types; end

    # pkg:gem/graphql#lib/graphql/schema.rb:1575
    def sanitized_printer(new_sanitized_printer = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1275
    def schema_directive(dir_class, **options); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1280
    def schema_directives; end

    # pkg:gem/graphql#lib/graphql/schema.rb:313
    def static_validator; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:524
    def subscription(new_subscription_object = T.unsafe(nil), &lazy_load_block); end

    # pkg:gem/graphql#lib/graphql/schema.rb:834
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:143
    def subscriptions(inherited: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:147
    ...
    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1704
    ...
    # @return [String]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:284
    def to_definition(context: T.unsafe(nil)); end

    # Return the GraphQL::Language::Document IDL AST for the schema
    # @return [GraphQL::Language::Document]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:290
    def to_document; end
    ...
    # @return [String]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:257
    def to_json(**args); end

    # pkg:gem/graphql#lib/graphql/schema.rb:166
    def trace_class(new_class = T.unsafe(nil)); end

    # @return [Class] Return the trace class to use for this mode, looking one up on the superclass if this Schema doesn't have one defined.
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:179
    ...
    # @return void
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:203
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:245
    def trace_modules_for(trace_mode); end

    # The options hash for this trace mode
    # @return [Hash]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1500
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1470
    def trace_with(trace_mod, mode: T.unsafe(nil), **options); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1428
    def tracer(new_tracer, silence_deprecation_warning: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema.rb:1441
    def tracers; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1333
    def type_error(type_error, context); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:342
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1319
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1303
    def unauthorized_object(unauthorized_error); end

    # pkg:gem/graphql#lib/graphql/schema.rb:662
    ...
    # @return void
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:320
    ...
    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:611
    def use_visibility_profile?; end

    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1150
    ...
    # pkg:gem/graphql#lib/graphql/schema.rb:1271
    ...
    # pkg:gem/graphql#lib/graphql/schema.rb:1935
    def add_trace_options_for(mode, new_options); end

    # @param t [Module, Array<Module>]
    # @return [void]
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:1952
    def add_type_and_traverse(t, root:); end

    # This is overridden in subclasses to check the inheritance chain
    #
    # pkg:gem/graphql#lib/graphql/schema.rb:2067
    def get_references_to(type_defn); end

    # pkg:gem/graphql#lib/graphql/schema.rb:2004
    def lazy_methods; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2026
    def non_introspection_types; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2046
    def own_directives; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2050
    def own_instrumenters; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2062
    def own_multiplex_analyzers; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2034
    def own_orphan_types; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2030
    def own_plugins; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2038
    def own_possible_types; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2058
    def own_query_analyzers; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2022
    def own_references_to; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2054
    def own_tracers; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2018
    def own_types; end

    # pkg:gem/graphql#lib/graphql/schema.rb:2042
...
class GraphQL::Schema::Addition
  ...
  # pkg:gem/graphql#lib/graphql/schema/addition.rb:42
  def add_directives_from(owner); end

  # pkg:gem/graphql#lib/graphql/schema/addition.rb:152
  def add_type(type, owner:, late_types:, path:); end

  # pkg:gem/graphql#lib/graphql/schema/addition.rb:50
  def add_type_and_traverse(new_types); end

  # Lookup using `own_types` here because it's ok to override
  # inherited types by name
  #
  # pkg:gem/graphql#lib/graphql/schema/addition.rb:38
  def get_local_type(name); end

  # pkg:gem/graphql#lib/graphql/schema/addition.rb:26
  def get_type(name); end

  # pkg:gem/graphql#lib/graphql/schema/addition.rb:22
  def references_to(thing, from:); end

  # pkg:gem/graphql#lib/graphql/schema/addition.rb:91
  def update_type_owner(owner, type); end
end

# pkg:gem/graphql#lib/graphql/schema/always_visible.rb:4
module GraphQL::Schema::AlwaysVisible
  # pkg:gem/graphql#lib/graphql/schema/always_visible.rb:10
  def visible?(_member, _context); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/always_visible.rb:5
    def use(schema, **opts); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/argument.rb:4
class GraphQL::Schema::Argument
  include ::GraphQL::Schema::Member::HasPath
  include ::GraphQL::Schema::Member::HasAstNode
  include ::GraphQL::Schema::Member::HasAuthorization
  include ::GraphQL::Schema::Member::HasAuthorization::InstanceConfigured
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:61
  ...
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:172
  def authorized?(obj, value, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:176
  def authorized_as_type?(obj, value, ctx, as_type:); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:168
  def authorizes?(context); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:267
  def coerce_into_values(parent_object, values, context, argument_values); end

  # @return [String] Comment for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:142
  def comment(text = T.unsafe(nil)); end

  # @return [String] Comment for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:139
  def comment=(_arg0); end

  # @param default_value [Object] The value to use when the client doesn't provide one
  # @return [Object] the value used when the client doesn't provide a value for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:112
  def default_value(new_default_value = T.unsafe(nil)); end

  # @return [Boolean] True if this argument has a default value
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:120
  def default_value?; end

  # @return [String] Deprecation reason for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:151
  def deprecation_reason(text = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:159
  def deprecation_reason=(new_reason); end

  # @return [String] Documentation for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:131
  def description(text = T.unsafe(nil)); end

  # @return [String] Documentation for this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:128
  def description=(_arg0); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:227
  def freeze; end

  # @return [Boolean] true if a resolver defined this argument
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:36
  def from_resolver?; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:15
  def graphql_name; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:106
  def inspect; end

  # @return [Symbol] This argument's name in Ruby keyword arguments
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:30
  def keyword; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:328
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:33
  def loads; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:18
  def owner; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:22
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:235
  def prepare_value(obj, value, context: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:124
  def replace_null_with_default?; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:221
  def statically_coercible?; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:209
  def type; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:199
  def type=(new_type); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:381
  def validate_default_value; end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:164
  def visible?(context); end

  private

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:418
  def recursively_prepare_input_object(value, type, context); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:446
  def validate_deprecated_or_optional(null:, deprecation_reason:); end

  # pkg:gem/graphql#lib/graphql/schema/argument.rb:434
  def validate_input_type(input_type); end
end

# pkg:gem/graphql#lib/graphql/schema/argument.rb:409
class GraphQL::Schema::Argument::InvalidDefaultValueError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/argument.rb:410
  def initialize(argument); end
end

# pkg:gem/graphql#lib/graphql/schema/built_in_types.rb:4
GraphQL::Schema::BUILT_IN_TYPES = T.let(T.unsafe(nil), Hash)

# @api private
#
# pkg:gem/graphql#lib/graphql/schema/base_64_encoder.rb:6
module GraphQL::Schema::Base64Encoder
  class << self
    # pkg:gem/graphql#lib/graphql/schema/base_64_encoder.rb:11
    def decode(encoded_text, nonce: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/base_64_encoder.rb:7
    def encode(unencoded_text, nonce: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/build_from_definition/resolve_map/default_resolve.rb:4
module GraphQL::Schema::BuildFromDefinition
  class << self
    # @see {Schema.from_definition}
    #
    # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:9
    def from_definition(schema_superclass, definition_string, parser: T.unsafe(nil), **kwargs); end

    # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:16
    def from_definition_path(schema_superclass, definition_path, parser: T.unsafe(nil), **kwargs); end

    # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:23
    def from_document(schema_superclass, document, default_resolve:, using: T.unsafe(nil), base_types: T.unsafe(nil), relay: T.unsafe(nil)); end
  end
end

# @api private
#
# pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:29
module GraphQL::Schema::BuildFromDefinition::Builder
  include ::GraphQL::EmptyObjects
  extend ::GraphQL::EmptyObjects
  extend ::GraphQL::Schema::BuildFromDefinition::Builder

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:328
  def args_to_kwargs(arg_owner, node); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:33
  def build(schema_superclass, document, default_resolve:, relay:, using: T.unsafe(nil), base_types: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:458
  def build_arguments(type_class, arguments, type_resolver); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:443
  def build_default_value(default_value); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:265
  def build_definition_from_node(definition, type_resolver, default_resolve, base_types); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:369
  def build_deprecation_reason(directives); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:482
  def build_directive(directive_definition, type_resolver); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:298
  def build_directives(definition, ast_node, type_resolver); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:346
  def build_enum_type(enum_type_definition, type_resolver, base_type); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:508
  def build_fields(owner, field_definitions, type_resolver, default_resolve:); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:432
  def build_input_object_type(input_object_type_definition, type_resolver, base_type); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:494
  def build_interface_type(interface_type_definition, type_resolver, base_type); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:426
  def build_interfaces(type_class, interface_names, type_resolver); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:413
  def build_object_type(object_type_definition, type_resolver, base_type); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:550
  def build_resolve_type(lookup_hash, directives, missing_type_handler); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:379
  def build_scalar_type(scalar_type_definition, type_resolver, base_type, default_resolve:); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:396
  ...
  def build_union_type(union_type_definition, type_resolver, base_type); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:357
  def build_values(type_class, enum_value_definitions, type_resolver); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:537
  def define_field_resolve_method(owner, method_name, field_name); end

  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:310
  ...
  # @return void
  #
  # pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:289
  def replace_late_bound_types_with_built_in(types); end
end

# pkg:gem/graphql#lib/graphql/schema/build_from_definition.rb:261
...
class GraphQL::Schema::BuildFromDefinition::ResolveMap::DefaultResolve
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/build_from_definition/resolve_map/default_resolve.rb:20
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema.rb:2092
...
#
# pkg:gem/graphql#lib/graphql/schema/directive.rb:9
class GraphQL::Schema::Directive < ::GraphQL::Schema::Member
  ...
  # pkg:gem/graphql#lib/graphql/schema/directive.rb:187
  def graphql_name; end
  ...
  # pkg:gem/graphql#lib/graphql/schema/directive.rb:277
  def assert_has_location(location); end

  # pkg:gem/graphql#lib/graphql/schema/directive.rb:240
  def assert_valid_owner; end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/directive.rb:53
    def default_directive(new_default_directive = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/directive.rb:63
    def default_directive?; end

    # Return a name based on the class name,
    # but downcase the first letter.
    #
    # pkg:gem/graphql#lib/graphql/schema/directive.rb:24
    def default_graphql_name; end

    # If false, this part of the query won't be evaluated
    #
    # pkg:gem/graphql#lib/graphql/schema/directive.rb:68
...
#
# pkg:gem/graphql#lib/graphql/schema/directive/flagged.rb:8
...
# pkg:gem/graphql#lib/graphql/schema/directive/flagged.rb:42
module GraphQL::Schema::Directive::Flagged::VisibleByFlag
  # pkg:gem/graphql#lib/graphql/schema/directive/flagged.rb:47
  def visible?(context); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/directive/flagged.rb:43
...
# pkg:gem/graphql#lib/graphql/schema/directive.rb:191
...
module GraphQL::Schema::Directive::OneOf::IsOneOf
  # pkg:gem/graphql#lib/graphql/schema/directive/one_of.rb:17
  def one_of?; end
end

# pkg:gem/graphql#lib/graphql/schema/directive.rb:193
GraphQL::Schema::Directive::QUERY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/schema/directive.rb:192
...
# pkg:gem/graphql#lib/graphql/schema/directive/specified_by.rb:5
...
class GraphQL::Schema::Directive::Transform < ::GraphQL::Schema::Directive
  ...
  class << self
    # Implement the Directive API
    #
    # pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:36
    def resolve(object, arguments, context); end

    # pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:58
    def resolve_field(ast_nodes, parent_type, field_defn, objects, arguments, context); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:30
GraphQL::Schema::Directive::Transform::TRANSFORMS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:67
class GraphQL::Schema::Directive::Transform::Transformer
  include ::GraphQL::Execution::PostProcessor

  # pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:69
  def initialize(transform); end

  # pkg:gem/graphql#lib/graphql/schema/directive/transform.rb:72
  def after_resolve(field_results); end
end
...
class GraphQL::Schema::Enum < ::GraphQL::Schema::Member
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/enum.rb:130
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/enum.rb:216
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/enum.rb:93
    def enum_values(context = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:231
    def inherited(child_class); end

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:176
    def kind; end

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:180
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/enum.rb:69
    def value(*args, value_method: T.unsafe(nil), **kwargs, &block); end

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:164
    def value_methods(new_value = T.unsafe(nil)); end

    # @return [Hash<String => GraphQL::Schema::EnumValue>] Possible values of this enum, keyed by name.
    #
    # pkg:gem/graphql#lib/graphql/schema/enum.rb:149
    def values(context = T.unsafe(nil)); end

    private

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:247
    def generate_value_method(value, configured_value_method); end

    # pkg:gem/graphql#lib/graphql/schema/enum.rb:243
    def own_values; end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/enum.rb:51
class GraphQL::Schema::Enum::MissingValuesError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/enum.rb:52
...
#
# pkg:gem/graphql#lib/graphql/schema/enum.rb:33
class GraphQL::Schema::Enum::UnresolvedValueError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/enum.rb:34
...
class GraphQL::Schema::EnumValue < ::GraphQL::Schema::Member
  ...
  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:81
  def authorized?(_ctx); end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:62
  def comment(new_comment = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:55
  def description(new_desc = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:28
  def graphql_name; end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:76
  def inspect; end

  # @return [Class] The enum type that owns this value
  #
  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:31
  def owner; end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:69
  def value(new_val = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/enum_value.rb:80
  def visible?(_ctx); end
end

# pkg:gem/graphql#lib/graphql/schema/field/connection_extension.rb:5
class GraphQL::Schema::Field
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:223
  ...
  # pkg:gem/graphql#lib/graphql/schema/field.rb:673
  def authorized?(object, args, context); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:667
  def authorizes?(context); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:398
  def broadcastable?; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:511
  def calculate_complexity(query:, nodes:, child_complexity:); end

  # @param text [String]
  # @return [String, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:424
  def comment(text = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:561
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:115
  def connection?; end

  # @return [Integer, nil] Applied to connections if {#has_default_page_size?}
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:607
  def default_page_size; end

  # @return [String, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:46
  def deprecation_reason; end

  # @param text [String]
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:410
  def description(text = T.unsafe(nil)); end

  # @param text [String]
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:25
  def description=(_arg0); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:34
  def dig_keys; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:50
  def directives; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:393
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:379
  def ensure_loaded; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:372
  def execution_mode; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:372
  def execution_mode_key; end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:476
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:451
  ...
  # @return [Array<Symbol>]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:493
  def extras(new_extras = T.unsafe(nil)); end

  # @param ctx [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:828
  def fetch_extra(extra_name, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:617
  def freeze; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:23
  def graphql_name; end

  # @return [Boolean] True if this field's {#default_page_size} should override the schema default.
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:602
  def has_default_page_size?; end

  # @return [Boolean] True if this field's {#max_page_size} should override the schema default.
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:586
  def has_max_page_size?; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:33
  def hash_key; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:98
  def inspect; end

  # @return [Boolean] Is this field a predefined introspection field?
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:94
  def introspection?; end

  # @return [Integer, nil] Applied to connections if {#has_max_page_size?}
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:591
  def max_page_size; end

  # @return [Boolean] Should we warn if this field's name conflicts with a built-in method?
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:179
  def method_conflict_warning?; end

  # @return [String] Method or hash key on the underlying object to look up
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:31
  def method_str; end

  # @return [Symbol] Method or hash key on the underlying object to look up
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:28
  def method_sym; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:102
  def mutation; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:86
  def original_name; end

  # @return [Class] The thing this field was defined on (type, mutation, resolver)
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:72
  def owner; end
  ...
  # @return Boolean
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:174
  def relay_node_field; end

  # @return Boolean
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:176
  ...
  # @param ctx [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:722
  def resolve(object, args, query_ctx); end

  # @return [Class, nil] The {Schema::Resolver} this field was derived from, if there is one
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:89
  def resolver; end

  # @return [Symbol] The method on the type to look up
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:37
  def resolver_method; end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:929
  def run_next_extensions_before_resolve(objs, args, ctx, extended, idx: T.unsafe(nil), &block); end

  # @return [Boolean] if true, the return type's `.scope_items` method will be applied to this field's return value
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:138
  def scoped?; end

  # @return [String, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:108
  def subscription_scope; end

  # @return [String, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:111
  def subscription_scope=(_arg0); end

  # @return [Boolean] Apply tracing to this field? (Default: skip scalars, this is the override value)
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:105
  def trace; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:633
  ...
  # @return [Module, GraphQL::Schema::NonNull, GraphQL::Schema::List, nil] the configured type for this field
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:626
  def type=(_arg0); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:659
  def visible?(context); end

  private

  # pkg:gem/graphql#lib/graphql/schema/field.rb:977
  def apply_own_complexity_to(child_complexity, query, nodes); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:840
  def assert_satisfactory_implementation(receiver, method_name, ruby_kwargs); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:954
  def run_extensions_before_resolve(obj, args, ctx, extended, idx: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:995
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field.rb:894
  ...
  class << self
    ...
    #   end
    #
    # pkg:gem/graphql#lib/graphql/schema/field.rb:165
    def connection_extension(new_extension_class = T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/field/connection_extension.rb:6
class GraphQL::Schema::Field::ConnectionExtension < ::GraphQL::Schema::FieldExtension
  # pkg:gem/graphql#lib/graphql/schema/field/connection_extension.rb:24
  def after_resolve(value:, object:, arguments:, context:, memo:); end

  # pkg:gem/graphql#lib/graphql/schema/field/connection_extension.rb:7
  def apply; end

  # Remove pagination args before passing it to a user method
  #
  # pkg:gem/graphql#lib/graphql/schema/field/connection_extension.rb:15
  def resolve(arguments:, context:, object: T.unsafe(nil), objects: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/field.rb:880
class GraphQL::Schema::Field::ExtendedState
  # pkg:gem/graphql#lib/graphql/schema/field.rb:881
  def initialize(args, object); end

  # pkg:gem/graphql#lib/graphql/schema/field.rb:888
...
# pkg:gem/graphql#lib/graphql/schema/field.rb:19
class GraphQL::Schema::Field::FieldImplementationFailed < ::GraphQL::Error; end

# pkg:gem/graphql#lib/graphql/schema/field.rb:625
class GraphQL::Schema::Field::MissingReturnTypeError < ::GraphQL::Error; end

# pkg:gem/graphql#lib/graphql/schema/field/scope_extension.rb:6
class GraphQL::Schema::Field::ScopeExtension < ::GraphQL::Schema::FieldExtension
  # pkg:gem/graphql#lib/graphql/schema/field/scope_extension.rb:7
...
#
# pkg:gem/graphql#lib/graphql/schema/field_extension.rb:11
class GraphQL::Schema::FieldExtension
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:19
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:92
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:151
  def after_resolve(arguments:, context:, memo:, object: T.unsafe(nil), objects: T.unsafe(nil), values: T.unsafe(nil), value: T.unsafe(nil)); end
  ...
  # @return [GraphQL::Schema::Field]
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:13
  def field; end

  # @return [Object]
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:16
  def options; end
  ...
  # @return [Object] The return value for this field.
  #
  # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:134
  def resolve(arguments:, context:, object: T.unsafe(nil), objects: T.unsafe(nil)); end
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:48
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:34
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/field_extension.rb:59
    def extras(new_extras = T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/find_inherited_value.rb:4
module GraphQL::Schema::FindInheritedValue
  include ::GraphQL::EmptyObjects

  private

  # pkg:gem/graphql#lib/graphql/schema/find_inherited_value.rb:15
...
class GraphQL::Schema::Finder
  ...
  # pkg:gem/graphql#lib/graphql/schema/finder.rb:26
  def find(path); end

  private

  # pkg:gem/graphql#lib/graphql/schema/finder.rb:57
  def find_in_directive(directive, path:); end

  # pkg:gem/graphql#lib/graphql/schema/finder.rb:137
  def find_in_enum_type(enum_type, path:); end

  # pkg:gem/graphql#lib/graphql/schema/finder.rb:103
  def find_in_field(field, path:); end

  # pkg:gem/graphql#lib/graphql/schema/finder.rb:90
  def find_in_fields_type(type, kind:, path:); end

  # pkg:gem/graphql#lib/graphql/schema/finder.rb:120
...
# pkg:gem/graphql#lib/graphql/schema/finder.rb:20
class GraphQL::Schema::Finder::MemberNotFoundError < ::ArgumentError; end

# pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:5
module GraphQL::Schema::HasSingleInputArgument
  mixes_in_class_methods ::GraphQL::Schema::HasSingleInputArgument::ClassMethods

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:19
  def call; end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:6
  def resolve_with_support(**inputs); end

  private

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:163
  def authorize_arguments(args, values); end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:26
  def flatten_arguments(inputs); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:15
    def included(base); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:57
module GraphQL::Schema::HasSingleInputArgument::ClassMethods
  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:85
  def all_field_argument_definitions; end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:81
  def any_field_arguments?; end

  # Also apply this argument to the input type:
  #
  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:90
  def argument(*args, own_argument: T.unsafe(nil), **kwargs, &block); end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:58
  def dummy; end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:69
  def field_arguments(context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:73
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:116
  def input_object_class(new_class = T.unsafe(nil)); end

  # @param new_input_type [Class, nil] If provided, it configures this mutation to accept `new_input_type` instead of generating an input type
  # @return [Class] The generated {Schema::InputObject} class for this mutation's `input`
  #
  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:125
  def input_type(new_input_type = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:77
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/has_single_input_argument.rb:137
  def generate_input_type; end
end

# pkg:gem/graphql#lib/graphql/schema/input_object.rb:4
class GraphQL::Schema::InputObject < ::GraphQL::Schema::Member
  ...
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:29
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:88
  def [](key); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:24
  def arguments; end

  # @return [GraphQL::Query::Context] The context for this query
  #
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:22
  def context; end

  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:56
  ...
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:48
  def to_h; end

  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:52
  def to_hash; end
  ...
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:70
  def unwrap_value(value); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:108
  ...
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:311
  def overwrite_argument(key, value); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:147
    def argument(*args, **kwargs, &block); end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:285
    def arguments(context = T.unsafe(nil), require_defined_arguments = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:120
    def authorized?(obj, value, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:116
    def authorizes?(ctx); end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:235
    def coerce_input(value, ctx); end

    # It's funny to think of a _result_ of an input object.
    # This is used for rendering the default value in introspection responses.
    #
    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:253
    def coerce_result(value, ctx); end
    ...
    # @return [void]
    #
    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:275
    def has_no_arguments(new_has_no_arguments); end

    # @return [Boolean] `true` if `has_no_arguments(true)` was configued
    #
    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:281
    def has_no_arguments?; end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:164
    def kind; end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:134
    def one_of; end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:143
    def one_of?; end

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:171
    def validate_non_null_input(input, ctx, max_errors: T.unsafe(nil)); end

    private

    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:303
    def define_accessor_method(method_name); end

    # Suppress redefinition warning for objectId arguments
    #
    # pkg:gem/graphql#lib/graphql/schema/input_object.rb:295
...
#
# pkg:gem/graphql#lib/graphql/schema/input_object.rb:14
class GraphQL::Schema::InputObject::ArgumentsAreRequiredError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/input_object.rb:15
  def initialize(input_object_type); end
end

# pkg:gem/graphql#lib/graphql/schema/interface.rb:4
module GraphQL::Schema::Interface
  ...
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:146
  def unwrap; end
end

# pkg:gem/graphql#lib/graphql/schema/interface.rb:6
module GraphQL::Schema::Interface::DefinitionMethods
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:23
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:70
  def included(child_class); end

  # pkg:gem/graphql#lib/graphql/schema/interface.rb:139
  def kind; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:119
  ...
  #   end
  #
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:46
  def resolver_methods(&block); end

  # pkg:gem/graphql#lib/graphql/schema/interface.rb:61
  def type_membership_class(membership_class = T.unsafe(nil)); end

  # @see {Schema::Warden} hides interfaces without visible implementations
  #
  # pkg:gem/graphql#lib/graphql/schema/interface.rb:57
  def visible?(context); end
end
...
class GraphQL::Schema::IntrospectionSystem
  ...
  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:59
  def dynamic_field(name:); end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:55
  def dynamic_fields; end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:51
  def entry_point(name:); end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:47
  ...
  # @return void
  #
  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:69
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:123
  def dup_type_class(type_class); end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:117
  def get_fields_from_class(class_sym:); end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:107
  def load_constant(class_name); end

  # pkg:gem/graphql#lib/graphql/schema/introspection_system.rb:90
  def resolve_late_binding(late_bound_type); end
end

# Error that is raised when [#Schema#from_definition] is passed an invalid schema definition string.
#
# pkg:gem/graphql#lib/graphql/schema.rb:99
...
class GraphQL::Schema::LateBoundType
  ...
  # pkg:gem/graphql#lib/graphql/schema/late_bound_type.rb:40
  def to_s; end
...
class GraphQL::Schema::List < ::GraphQL::Schema::Wrapper
  ...
  # pkg:gem/graphql#lib/graphql/schema/list.rb:25
  def authorizes?(ctx); end

  # pkg:gem/graphql#lib/graphql/schema/list.rb:43
  def coerce_input(value, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/list.rb:39
  def coerce_result(value, ctx); end

  # Also for implementing introspection
  #
  # pkg:gem/graphql#lib/graphql/schema/list.rb:35
  def description; end

  # This is for introspection, where it's expected the name will be `null`
  #
  # pkg:gem/graphql#lib/graphql/schema/list.rb:30
  def graphql_name; end

  # @return [GraphQL::TypeKinds::LIST]
  #
  # pkg:gem/graphql#lib/graphql/schema/list.rb:12
  def kind; end

  # @return [true]
  #
  # pkg:gem/graphql#lib/graphql/schema/list.rb:17
  def list?; end

  # pkg:gem/graphql#lib/graphql/schema/list.rb:21
  def to_type_signature; end

  # pkg:gem/graphql#lib/graphql/schema/list.rb:52
  def validate_non_null_input(value, ctx, max_errors: T.unsafe(nil)); end

  private

  # pkg:gem/graphql#lib/graphql/schema/list.rb:83
  def add_max_errors_reached_message(result); end

  # pkg:gem/graphql#lib/graphql/schema/list.rb:74
...
#
# pkg:gem/graphql#lib/graphql/schema/loader.rb:10
module GraphQL::Schema::Loader
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/loader.rb:16
  def load(introspection_result); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/loader.rb:197
    def build_arguments(arg_owner, args, type_resolver); end

    # pkg:gem/graphql#lib/graphql/schema/loader.rb:173
    def build_fields(type_defn, fields, type_resolver); end

    private

    # pkg:gem/graphql#lib/graphql/schema/loader.rb:160
    def define_directive(directive, type_resolver); end

    # pkg:gem/graphql#lib/graphql/schema/loader.rb:99
    def define_type(type, type_resolver); end

    # pkg:gem/graphql#lib/graphql/schema/loader.rb:78
    def extract_default_value(default_value_str, input_value_ast); end

    # pkg:gem/graphql#lib/graphql/schema/loader.rb:59
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:7
class GraphQL::Schema::Member
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/schema/member.rb:36
    def authorizes?(_ctx); end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:11
module GraphQL::Schema::Member::BaseDSLMethods
  include ::GraphQL::Schema::FindInheritedValue
  include ::GraphQL::EmptyObjects

  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:119
  ...
  # @return [String, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:47
  def comment(new_comment = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:107
  def default_graphql_name; end
  ...
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:33
  def description(new_description = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:76
  def introspection(new_introspection = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:86
  def introspection?; end

  # The mutation this type was derived from, if it was derived from a mutation
  # @return [Class]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:92
  def mutation(mutation_class = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:102
  def unwrap; end

  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:115
  def visible?(context); end
  ...
  # without any namespaces and with any `-Type` suffix removed
  #
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:129
...
#
# pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:59
module GraphQL::Schema::Member::BaseDSLMethods::ConfigurationExtension
  # pkg:gem/graphql#lib/graphql/schema/member/base_dsl_methods.rb:60
  def inherited(child_class); end
end

# @api private
#
# pkg:gem/graphql#lib/graphql/schema/member/build_type.rb:6
...
# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:5
module GraphQL::Schema::Member::HasArguments
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:70
  def add_argument(arg_defn); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:223
  def all_argument_definitions; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:115
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:39
  def argument(arg_name = T.unsafe(nil), type_expr = T.unsafe(nil), desc = T.unsafe(nil), **kwargs, &definition_block); end

  # @param new_arg_class [Class] A class to use for building argument definitions
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:246
  def argument_class(new_arg_class = T.unsafe(nil)); end

  # @return [Hash<String => GraphQL::Schema::Argument] Arguments defined on this thing, keyed by name. Includes inherited definitions
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:102
  def arguments(context = T.unsafe(nil), _require_defined_arguments = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:329
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:259
  def coerce_arguments(parent_object, values, context, &block); end

  # @return [GraphQL::Schema::Argument, nil] Argument defined on this thing, fetched by name.
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:234
  def get_argument(argument_name, context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:451
  def own_arguments; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:86
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:316
...
# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:337
module GraphQL::Schema::Member::HasArguments::ArgumentClassAccessor
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:338
  def argument_class(new_arg_class = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:349
module GraphQL::Schema::Member::HasArguments::ArgumentObjectLoader
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:374
  def authorize_application_object(argument, id, context, loaded_application_object); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:369
  def load_and_authorize_application_object(argument, id, context); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:361
  ...
  # @api public
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:445
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:357
  def object_from_id(type, id, context); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:119
module GraphQL::Schema::Member::HasArguments::ClassConfigured
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:120
  def inherited(child_class); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:125
module GraphQL::Schema::Member::HasArguments::ClassConfigured::InheritedArguments
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:146
  def all_argument_definitions; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:142
  def any_arguments?; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:126
  def arguments(context = T.unsafe(nil), require_defined_arguments = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:159
  def get_argument(argument_name, context = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:174
module GraphQL::Schema::Member::HasArguments::FieldConfigured
  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:197
  def all_argument_definitions; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:193
  def any_arguments?; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:175
  def arguments(context = T.unsafe(nil), _require_defined_arguments = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:321
...
# pkg:gem/graphql#lib/graphql/schema/member/has_arguments.rb:450
GraphQL::Schema::Member::HasArguments::NO_ARGUMENTS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/schema/member/has_ast_node.rb:5
module GraphQL::Schema::Member::HasAstNode
  ...
  # pkg:gem/graphql#lib/graphql/schema/member/has_ast_node.rb:11
...
# pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:5
module GraphQL::Schema::Member::HasAuthorization
  include ::GraphQL::Schema::Member::HasAuthorization::InstanceConfigured

  # pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:17
  def authorized?(object, context); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:10
    def extended(child_class); end

    # pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:6
    def included(child_class); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:27
module GraphQL::Schema::Member::HasAuthorization::ClassConfigured
  # pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:28
  def authorizes?(context); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:21
module GraphQL::Schema::Member::HasAuthorization::InstanceConfigured
  # pkg:gem/graphql#lib/graphql/schema/member/has_authorization.rb:22
  def authorizes?(context); end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:8
module GraphQL::Schema::Member::HasDataloader
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:19
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:36
  def dataload_all(source_class, *source_args, load_keys); end

  # @see dataload_association Like `dataload_assocation` but accepts an Array of records (required param)
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:88
  def dataload_all_associations(records, association_name, scope: T.unsafe(nil)); end

  # @see dataload_record Like `dataload_record`, but accepts an Array of `find_by_values`
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:60
  def dataload_all_records(model, find_by_values, find_by: T.unsafe(nil)); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:78
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:49
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_dataloader.rb:10
  def dataloader; end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_deprecation_reason.rb:6
module GraphQL::Schema::Member::HasDeprecationReason
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_deprecation_reason.rb:8
  def deprecation_reason; end
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/schema/member/has_deprecation_reason.rb:22
    def extended(child_class); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_deprecation_reason.rb:27
module GraphQL::Schema::Member::HasDeprecationReason::ClassMethods
  # pkg:gem/graphql#lib/graphql/schema/member/has_deprecation_reason.rb:28
  def deprecation_reason(new_reason = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:6
module GraphQL::Schema::Member::HasDirectives
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:22
  def directive(dir_class, **options); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:36
  def directives; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:12
  def inherited(child_cls); end
  ...
  # @return [viod]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:31
  ...
  class << self
    ...
    # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:50
    def get_directives(schema_member, directives, directives_method); end

    # pkg:gem/graphql#lib/graphql/schema/member/has_directives.rb:46
...
#
# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:7
module GraphQL::Schema::Member::HasFields
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:113
  def add_field(field_defn, method_conflict_warning: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:180
  ...
  # @return [GraphQL::Schema::Field]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:58
  def field(name_positional = T.unsafe(nil), type_positional = T.unsafe(nil), desc_positional = T.unsafe(nil), **kwargs, &definition_block); end

  # @return [Class] The class to initialize when adding fields to this kind of schema member
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:141
  def field_class(new_field_class = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:151
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:165
  def has_no_fields(new_has_no_fields); end

  # @return [Boolean] `true` if `has_no_fields(true)` was configued
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:171
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:176
  def own_fields; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:318
  def conflict_field_name_warning(field_defn); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:284
  def inherited(subclass); end

  # If `type` is an interface, and `self` has a type membership for `type`, then make sure it's visible.
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:294
  def visible_interface_implementation?(type, context, warden); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:277
    def extended(child_class); end

    # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:271
    def included(child_class); end
  end
end
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:108
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:102
GraphQL::Schema::Member::HasFields::GRAPHQL_RUBY_KEYWORDS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:192
module GraphQL::Schema::Member::HasFields::InterfaceMethods
  # @return [Hash<String => GraphQL::Schema::Field>] Fields on this object, keyed by name, including inherited fields
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:207
  def fields(context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:193
  def get_field(field_name, context = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:226
module GraphQL::Schema::Member::HasFields::ObjectMethods
  # @return [Hash<String => GraphQL::Schema::Field>] Fields on this object, keyed by name, including inherited fields
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:246
  def fields(context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:227
  def get_field(field_name, context = T.unsafe(nil)); end
end
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema/member/has_fields.rb:97
GraphQL::Schema::Member::HasFields::RUBY_KEYWORDS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:6
module GraphQL::Schema::Member::HasInterfaces
  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:7
  def implements(*new_interfaces, **options); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:57
  def interface_type_memberships; end

  # param context [Query::Context] If omitted, skip filtering.
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:102
  def interfaces(context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:53
  def own_interface_type_memberships; end

  private

  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:134
  def inherited(subclass); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:130
    def extended(child_class); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:61
module GraphQL::Schema::Member::HasInterfaces::ClassConfigured
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:67
  def inherited(child_class); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:72
module GraphQL::Schema::Member::HasInterfaces::ClassConfigured::InheritedInterfaces
  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:89
  def interface_type_memberships; end

  # pkg:gem/graphql#lib/graphql/schema/member/has_interfaces.rb:73
  def interfaces(context = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_path.rb:6
module GraphQL::Schema::Member::HasPath
  # @return [String] A description of this member's place in the GraphQL schema
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_path.rb:8
  def path; end
end

# Set up a type-specific error to make debugging & bug tracker integration better
#
# pkg:gem/graphql#lib/graphql/schema/member/has_unresolved_type_error.rb:7
module GraphQL::Schema::Member::HasUnresolvedTypeError
  private

  # pkg:gem/graphql#lib/graphql/schema/member/has_unresolved_type_error.rb:9
  def add_unresolved_type_error(child_class); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:5
module GraphQL::Schema::Member::HasValidators
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:12
  def validates(validation_config); end

  # @return [Array<GraphQL::Schema::Validator>]
  #
  # pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:20
  def validators; end
...
# pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:24
module GraphQL::Schema::Member::HasValidators::ClassConfigured
  # pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:25
  def inherited(child_cls); end
end

# pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:30
module GraphQL::Schema::Member::HasValidators::ClassConfigured::ClassValidators
  include ::GraphQL::EmptyObjects

  # pkg:gem/graphql#lib/graphql/schema/member/has_validators.rb:33
  def validators; end
end

# pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:6
module GraphQL::Schema::Member::RelayShortcuts
  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:53
  def connection_type; end

  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:24
  def connection_type_class(new_connection_type_class = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:41
  def edge_type; end

  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:7
  def edge_type_class(new_edge_type_class = T.unsafe(nil)); end

  protected

  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:67
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/relay_shortcuts.rb:81
  def initialize_relay_metadata; end
end

# pkg:gem/graphql#lib/graphql/schema/member/scoped.rb:6
module GraphQL::Schema::Member::Scoped
  # pkg:gem/graphql#lib/graphql/schema/member/scoped.rb:31
  def inherited(subclass); end

  # pkg:gem/graphql#lib/graphql/schema/member/scoped.rb:19
...
module GraphQL::Schema::Member::TypeSystemHelpers
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:52
  def kind; end

  # @return [Boolean] true if this is a list type. A non-nullable list is considered a list.
  #
  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:43
  def list?; end

  # @return [Boolean] true if this is a non-nullable type. A nullable list of non-nullables is considered nullable.
  #
  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:38
  def non_null?; end

  # @return [Schema::List] Make a list-type representation of this type
  #
  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:26
  def to_list_type; end

  # @return [Schema::NonNull] Make a non-null-type representation of this type
  #
  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:14
  def to_non_null_type; end

  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:47
  def to_type_signature; end

  private

  # pkg:gem/graphql#lib/graphql/schema/member/type_system_helpers.rb:58
  def inherited(subclass); end
end

# pkg:gem/graphql#lib/graphql/schema/member/validates_input.rb:6
module GraphQL::Schema::Member::ValidatesInput
  # pkg:gem/graphql#lib/graphql/schema/member/validates_input.rb:23
  ...
  # pkg:gem/graphql#lib/graphql/schema/member/validates_input.rb:11
...
class GraphQL::Schema::Mutation < ::GraphQL::Schema::Resolver
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/schema/mutation.rb:73
    def visible?(context); end

    private

    # pkg:gem/graphql#lib/graphql/schema/mutation.rb:79
    def conflict_field_name_warning(field_defn); end

    # Override this to attach self as `mutation`
    #
    # pkg:gem/graphql#lib/graphql/schema/mutation.rb:84
...
class GraphQL::Schema::NonNull < ::GraphQL::Schema::Wrapper
  ...
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:49
  def coerce_input(value, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:57
  def coerce_result(value, ctx); end

  # This is for implementing introspection
  #
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:62
  def description; end

  # This is for introspection, where it's expected the name will be `null`
  #
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:45
  def graphql_name; end

  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:30
  def inspect; end

  # @return [GraphQL::TypeKinds::NON_NULL]
  #
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:12
  def kind; end

  # @return [Boolean] True if this type wraps a list type
  #
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:22
  def list?; end

  # @return [true]
  #
  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:17
  def non_null?; end

  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:26
  def to_type_signature; end

  # pkg:gem/graphql#lib/graphql/schema/non_null.rb:34
  def validate_input(value, ctx, max_errors: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/object.rb:7
class GraphQL::Schema::Object < ::GraphQL::Schema::Member
  include ::GraphQL::Schema::Member::HasDataloader
  extend ::GraphQL::Schema::Member::HasAuthorization
  extend ::GraphQL::Schema::Member::HasAuthorization::ClassConfigured
  extend ::GraphQL::Schema::Member::HasFields
  extend ::GraphQL::Schema::Member::HasFields::ObjectMethods
  extend ::GraphQL::Schema::Member::HasInterfaces
  extend ::GraphQL::Schema::Member::HasInterfaces::ClassConfigured

  # pkg:gem/graphql#lib/graphql/schema/object.rb:122
  def initialize(object, context); end

  # @return [GraphQL::Query::Context] the context instance for this query
  #
  # pkg:gem/graphql#lib/graphql/schema/object.rb:25
  def context; end

  # @return [GraphQL::Dataloader]
  #
  # pkg:gem/graphql#lib/graphql/schema/object.rb:28
  def dataloader; end

  # @return [Object] the application object this type is wrapping
  #
  # pkg:gem/graphql#lib/graphql/schema/object.rb:22
  def object; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/object.rb:34
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/object.rb:69
    def authorized_new(object, context); end

    # Set up a type-specific invalid null error to use when this object's non-null fields wrongly return `nil`.
    # It should help with debugging and bug tracker integrations.
    #
    # pkg:gem/graphql#lib/graphql/schema/object.rb:130
    def const_missing(name); end

    # pkg:gem/graphql#lib/graphql/schema/object.rb:140
    def kind; end

    # pkg:gem/graphql#lib/graphql/schema/object.rb:117
    def scoped_new(object, context); end

    # This is called by the runtime to return an object to call methods on.
    #
    # pkg:gem/graphql#lib/graphql/schema/object.rb:48
    def wrap(object, context); end

    # pkg:gem/graphql#lib/graphql/schema/object.rb:43
    def wrap_scoped(object, context); end

    protected

    # pkg:gem/graphql#lib/graphql/schema/object.rb:41
    def new(*_arg0); end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/object.rb:14
class GraphQL::Schema::Object::FieldsAreRequiredError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/object.rb:15
...
class GraphQL::Schema::Printer < ::GraphQL::Language::Printer
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/printer.rb:40
  def initialize(schema, context: T.unsafe(nil), introspection: T.unsafe(nil)); end

  # Return a GraphQL schema string for the defined types in the schema
  #
  # pkg:gem/graphql#lib/graphql/schema/printer.rb:88
  def print_schema; end

  # pkg:gem/graphql#lib/graphql/schema/printer.rb:92
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/printer.rb:52
    ...
    # @param except [<#call(member, ctx)>]
    #
    # pkg:gem/graphql#lib/graphql/schema/printer.rb:82
    def print_schema(schema, **args); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/printer.rb:97
class GraphQL::Schema::Printer::IntrospectionPrinter < ::GraphQL::Language::Printer
  # pkg:gem/graphql#lib/graphql/schema/printer.rb:98
  def print_schema_definition(schema); end
end

# pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:4
module GraphQL::Schema::RactorShareable
  class << self
    # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:5
    def extended(schema_class); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:10
module GraphQL::Schema::RactorShareable::SchemaExtension
  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:12
  def freeze_error_handlers(handlers); end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:20
  def freeze_schema; end
end

# pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:64
module GraphQL::Schema::RactorShareable::SchemaExtension::FrozenMethods
  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:69
  def directives; end

  # This actually accumulates info during execution...
  # How to support it?
  #
  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:73
  def lazy?(_obj); end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:66
  def multiplex_analyzers; end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:68
  def plugins; end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:67
  def query_analyzers; end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:75
  def resolves_lazies?; end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:74
  def sync_lazy(obj); end

  # pkg:gem/graphql#lib/graphql/schema/ractor_shareable.rb:65
  def tracers; end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/relay_classic_mutation.rb:22
class GraphQL::Schema::RelayClassicMutation < ::GraphQL::Schema::Mutation
  ...
  # pkg:gem/graphql#lib/graphql/schema/relay_classic_mutation.rb:54
  def call; end

  # Override {GraphQL::Schema::Resolver#resolve_with_support} to
  # delete `client_mutation_id` from the kwargs.
  #
  # pkg:gem/graphql#lib/graphql/schema/relay_classic_mutation.rb:34
  def resolve_with_support(**inputs); end
end
...
class GraphQL::Schema::Resolver
  ...
  extend ::GraphQL::Schema::Member::HasDeprecationReason::ClassMethods

  # @param object [Object] The application object that this field is being resolved on
  # @param context [GraphQL::Query::Context]
  # @param field [GraphQL::Schema::Field]
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:37
  def initialize(object:, context:, field:); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:128
  def arguments; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:222
  def authorized?(**inputs); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:62
  def call; end

  # @api private {GraphQL::Schema::Mutation} uses this to clear the dataloader cache
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:187
  def call_resolve(args_hash); end

  # @return [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:55
  def context; end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def exec_index; end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def exec_index=(_arg0); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def exec_result; end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def exec_result=(_arg0); end

  # @return [GraphQL::Schema::Field]
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:58
  def field; end
  ...
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def field_resolve_step=(_arg0); end

  # @return [Object] The application object this field is being resolved on
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:52
  def object; end
  ...
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:60
  def prepared_arguments=(_arg0); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def raw_arguments; end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:49
  def raw_arguments=(_arg0); end
  ...
  # @return [Boolean, early_return_data] If `false`, execution will stop (and `early_return_data` will be returned instead, if present.)
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:211
  def ready?(**args); end

  # Do the work. Everything happens here.
  # @return [Object] An object corresponding to the return type
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:197
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:136
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:238
  def unauthorized_object(err); end

  private

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:244
  def authorize_arguments(args, inputs); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:290
  def get_argument(name, context = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/resolver.rb:263
  def load_arguments(args); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:307
    def all_field_argument_definitions; end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:299
    def any_field_arguments?; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:448
    def argument(*args, **kwargs, &block); end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:228
    def authorizes?(context); end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:385
    def broadcastable(new_broadcastable); end

    # @return [Boolean, nil]
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:390
    def broadcastable?; end

    # Specifies the complexity of the field. Defaults to `1`
    # @return [Integer, Proc]
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:378
    def complexity(new_complexity = T.unsafe(nil)); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:423
    def default_page_size(new_default_page_size = T.unsafe(nil)); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:457
    def extension(extension, **options); end

    # @api private
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:463
    def extensions; end

    # Additional info injected into {#resolve}
    # @see {GraphQL::Schema::Field#extras}
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:322
    def extras(new_extras = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:295
    def field_arguments(context = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:303
    def get_field_argument(name, context = T.unsafe(nil)); end

    # @return [Boolean] `true` if this resolver or a superclass has an assigned `default_page_size`
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:436
    def has_default_page_size?; end

    # @return [Boolean] `true` if this resolver or a superclass has an assigned `max_page_size`
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:415
    def has_max_page_size?; end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:482
    def inherited(child_class); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:402
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:335
    def null(allow_null = T.unsafe(nil)); end

    # Default `:resolve` set below.
    # @return [Symbol] The method to call on instances of this object to resolve the field
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:313
    def resolve_method(new_method = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:343
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:358
    def type(new_type = T.unsafe(nil), null: T.unsafe(nil)); end

    # A non-normalized type configuration, without `null` applied
    #
    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:441
    def type_expr; end

    private

    # pkg:gem/graphql#lib/graphql/schema/resolver.rb:489
...
#
# pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:10
module GraphQL::Schema::Resolver::HasPayloadType
  # pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:62
  def field(*args, **kwargs, &block); end

  # pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:36
  ...
  # @return [Class]
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:49
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:16
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:89
  def generate_payload_type; end
end

# pkg:gem/graphql#lib/graphql/schema/resolver/has_payload_type.rb:60
GraphQL::Schema::Resolver::HasPayloadType::NO_INTERFACES = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/schema/scalar.rb:4
class GraphQL::Schema::Scalar < ::GraphQL::Schema::Member
  extend ::GraphQL::Schema::Member::ValidatesInput

  class << self
    # pkg:gem/graphql#lib/graphql/schema/scalar.rb:8
    def coerce_input(val, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/scalar.rb:12
    ...
    # pkg:gem/graphql#lib/graphql/schema/scalar.rb:16
    def kind; end

    # pkg:gem/graphql#lib/graphql/schema/scalar.rb:20
    def specified_by_url(new_url = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/scalar.rb:43
    def validate_non_null_input(value, ctx, max_errors: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql#lib/graphql/schema.rb:2072
module GraphQL::Schema::SubclassGetReferencesTo
  # pkg:gem/graphql#lib/graphql/schema.rb:2073
  def get_references_to(type_defn); end
end
...
#
# pkg:gem/graphql#lib/graphql/schema/subscription.rb:14
class GraphQL::Schema::Subscription < ::GraphQL::Schema::Resolver
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:21
  def initialize(object:, context:, field:); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:34
  def call_resolve(args_hash); end

  # @return [Subscriptions::Event] This object is used as a representation of this subscription for the backend
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:228
  def event; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:138
  def load_application_object_failed(err); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:92
  def resolve(**args); end

  # Wrap the user-defined `#subscribe` hook
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:100
  def resolve_subscribe(**args); end

  # Wrap the user-provided `#update` hook
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:118
  def resolve_update(**args); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:64
  def resolve_with_support(**args); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:112
  def subscribe(args = T.unsafe(nil)); end

  # @return [Boolean] `true` if {#write_subscription} was called already
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:223
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:148
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:131
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:212
  ...
  class << self
    ...
    # @return [Symbol]
    #
    # pkg:gem/graphql#lib/graphql/schema/subscription.rb:164
    def subscription_scope(new_scope = T.unsafe(nil), optional: T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/subscription.rb:175
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/subscription.rb:199
    def topic_for(arguments:, field:, scope:); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/subscription.rb:155
class GraphQL::Schema::Subscription::EarlyUnsubscribe < ::GraphQL::RuntimeError
  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:156
  def unsubscribed_result; end

  # pkg:gem/graphql#lib/graphql/schema/subscription.rb:156
  def unsubscribed_result=(_arg0); end
end

# pkg:gem/graphql#lib/graphql/schema/subscription.rb:17
...
class GraphQL::Schema::Timeout
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/timeout.rb:102
  def max_seconds(query); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/timeout.rb:36
...
#
# pkg:gem/graphql#lib/graphql/schema/timeout.rb:129
class GraphQL::Schema::Timeout::TimeoutError < ::GraphQL::ExecutionError
  # pkg:gem/graphql#lib/graphql/schema/timeout.rb:130
  def initialize(field); end
end

# pkg:gem/graphql#lib/graphql/schema/timeout.rb:45
module GraphQL::Schema::Timeout::Trace
  # @param max_seconds [Numeric] how many seconds the query should be allowed to resolve new fields
  #
  # pkg:gem/graphql#lib/graphql/schema/timeout.rb:47
  def initialize(timeout:, **rest); end

  # pkg:gem/graphql#lib/graphql/schema/timeout.rb:71
  def begin_execute_field(field, _arguments, _objects, query); end

  # pkg:gem/graphql#lib/graphql/schema/timeout.rb:52
  def execute_multiplex(multiplex:); end
end

# @api private
#
# pkg:gem/graphql#lib/graphql/schema/type_expression.rb:5
...
# it is a member.
#
# pkg:gem/graphql#lib/graphql/schema/type_membership.rb:7
class GraphQL::Schema::TypeMembership
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:12
  def abstract_type; end

  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:36
  def graphql_name; end

  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:44
  def inspect; end

  # @return [Class<GraphQL::Schema::Object>]
  #
  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:9
  def object_type; end
  ...
  # @return [Hash]
  #
  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:15
  def options; end

  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:40
  def path; end

  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:48
  def type_class; end

  # @return [Boolean] if false, {#object_type} will be treated as _not_ a member of {#abstract_type}
  #
  # pkg:gem/graphql#lib/graphql/schema/type_membership.rb:30
  def visible?(ctx); end
end

# pkg:gem/graphql#lib/graphql/schema/union.rb:4
class GraphQL::Schema::Union < ::GraphQL::Schema::Member
  extend ::GraphQL::Schema::Member::HasUnresolvedTypeError

  class << self
    # pkg:gem/graphql#lib/graphql/schema/union.rb:31
    ...
    # pkg:gem/graphql#lib/graphql/schema/union.rb:43
    def kind; end

    # pkg:gem/graphql#lib/graphql/schema/union.rb:13
    def possible_types(*types, context: T.unsafe(nil), **options); end

    # pkg:gem/graphql#lib/graphql/schema/union.rb:35
    def type_membership_class(membership_class = T.unsafe(nil)); end

    # pkg:gem/graphql#lib/graphql/schema/union.rb:47
    def type_memberships; end

    private

    # pkg:gem/graphql#lib/graphql/schema/union.rb:72
    def assert_valid_union_member(type_defn); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/unique_within_type.rb:6
...
class GraphQL::Schema::UnresolvedLateBoundTypeError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema.rb:92
  def initialize(type:); end

  # pkg:gem/graphql#lib/graphql/schema.rb:91
  def type; end
end

# pkg:gem/graphql#lib/graphql/schema/validator.rb:5
class GraphQL::Schema::Validator
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/validator.rb:29
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/validator.rb:47
  ...
  def validation_parameter(config_value); end

  class << self
    # pkg:gem/graphql#lib/graphql/schema/validator.rb:109
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/validator.rb:55
    ...
    # @return [void]
    #
    # pkg:gem/graphql#lib/graphql/schema/validator.rb:95
    ...
    # @return [void]
    #
    # pkg:gem/graphql#lib/graphql/schema/validator.rb:103
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/validator.rb:131
...
#
# pkg:gem/graphql#lib/graphql/schema/validator/all_validator.rb:23
class GraphQL::Schema::Validator::AllValidator < ::GraphQL::Schema::Validator
  # pkg:gem/graphql#lib/graphql/schema/validator/all_validator.rb:24
  def initialize(validated:, allow_blank: T.unsafe(nil), allow_null: T.unsafe(nil), **validators); end

  # pkg:gem/graphql#lib/graphql/schema/validator/all_validator.rb:30
  def validate(object, context, value); end
end
...
class GraphQL::Schema::Validator::AllowBlankValidator < ::GraphQL::Schema::Validator
  ...
  def initialize(allow_blank_positional = T.unsafe(nil), allow_blank: T.unsafe(nil), message: T.unsafe(nil), **default_options); end

  # pkg:gem/graphql#lib/graphql/schema/validator/allow_blank_validator.rb:17
...
class GraphQL::Schema::Validator::AllowNullValidator < ::GraphQL::Schema::Validator
  ...
  def initialize(allow_null_positional = T.unsafe(nil), allow_null: T.unsafe(nil), message: T.unsafe(nil), **default_options); end

  # pkg:gem/graphql#lib/graphql/schema/validator/allow_null_validator.rb:18
  def validate(_object, _context, value); end
end

# pkg:gem/graphql#lib/graphql/schema/validator/allow_null_validator.rb:11
...
class GraphQL::Schema::Validator::ExclusionValidator < ::GraphQL::Schema::Validator
  ...
  # pkg:gem/graphql#lib/graphql/schema/validator/exclusion_validator.rb:23
  def validate(_object, _context, value); end
end
...
class GraphQL::Schema::Validator::FormatValidator < ::GraphQL::Schema::Validator
  ...
  # pkg:gem/graphql#lib/graphql/schema/validator/format_validator.rb:36
  def validate(_object, _context, value); end
end
...
class GraphQL::Schema::Validator::InclusionValidator < ::GraphQL::Schema::Validator
  ...
  # pkg:gem/graphql#lib/graphql/schema/validator/inclusion_validator.rb:25
  def validate(_object, _context, value); end
end
...
class GraphQL::Schema::Validator::LengthValidator < ::GraphQL::Schema::Validator
  ...
  # pkg:gem/graphql#lib/graphql/schema/validator/length_validator.rb:45
  def validate(_object, _context, value); end
end
...
#   end
#
# pkg:gem/graphql#lib/graphql/schema/validator/required_validator.rb:44
class GraphQL::Schema::Validator::RequiredValidator < ::GraphQL::Schema::Validator
  ...
  # @param message [String]
  #
  # pkg:gem/graphql#lib/graphql/schema/validator/required_validator.rb:49
  ...
  # pkg:gem/graphql#lib/graphql/schema/validator/required_validator.rb:158
  def arg_keyword_to_graphql_name(argument_definitions, arg_keyword); end

  # pkg:gem/graphql#lib/graphql/schema/validator/required_validator.rb:130
  def build_message(context); end

  # pkg:gem/graphql#lib/graphql/schema/validator/required_validator.rb:62
  def validate(_object, context, value); end
end

# pkg:gem/graphql#lib/graphql/schema/validator.rb:116
class GraphQL::Schema::Validator::ValidationFailedError < ::GraphQL::ExecutionError
  # pkg:gem/graphql#lib/graphql/schema/validator.rb:119
  def initialize(errors:); end

  # pkg:gem/graphql#lib/graphql/schema/validator.rb:117
  def errors; end
end

# Use this plugin to make some parts of your schema hidden from some viewers.
#
# pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:5
class GraphQL::Schema::Visibility
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:29
  def initialize(schema, dynamic:, preload:, profiles:, migration_errors:, configuration_inherited: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:63
  def all_directives; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:68
  def all_interface_type_memberships; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:73
  def all_references; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:154
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:139
  def dup_for(other_schema); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:55
  def freeze; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:78
  def get_type(type_name); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:132
  def introspection_system_configured(introspection_system); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:150
  def migration_errors?; end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:117
  def mutation_configured(mutation_type); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:127
  def orphan_types_configured(orphan_types); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:89
  def preload; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:85
  def preload?; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:156
  def profile_for(context); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:112
  def query_configured(query_type); end

  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:122
  def subscription_configured(subscription_type); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:180
  def top_level; end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:185
  def top_level_profile(refresh: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:83
  def types; end
  ...
  # @api private
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:183
  def unfiltered_interface_type_memberships; end

  private

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:207
  def ensure_all_loaded(types_to_visit); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:220
  def load_all(types: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:194
  def require_if_preloaded(config_message, config_code); end
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/visibility.rb:21
...
#
# pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:29
class GraphQL::Schema::Visibility::Migration < ::GraphQL::Schema::Visibility::Profile
  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:79
  def initialize(context:, schema:, visibility:, name: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:131
  ...
  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:136
  ...
  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:154
  ...
  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:104
...
# pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:108
GraphQL::Schema::Visibility::Migration::PUBLIC_PROFILE_METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:30
class GraphQL::Schema::Visibility::Migration::RuntimeTypesMismatchError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:31
  def initialize(method_called, warden_result, profile_result, method_args); end

  private

  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:44
  def compare_results(warden_result, profile_result); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/migration.rb:63
...
#
# pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:15
class GraphQL::Schema::Visibility::Profile
  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:63
  def initialize(context:, schema:, visibility:, name: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:225
  def all_types; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:230
  def all_types_h; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:178
  def argument(owner, arg_name); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:174
  def arguments(owner); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:239
  def directive_exists?(dir_name); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:243
  def directives; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:235
  def enum_values(owner); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:166
  def field(owner, field_name); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:138
  def field_on_visible_interface?(field, owner); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:170
  def fields(owner); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:34
  def freeze; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:205
  def interfaces(obj_or_int_type); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:249
  def loadable?(t, _ctx); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:253
  def loadable_possible_types(t, _ctx); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:257
  def loaded_types; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:217
  def mutation_root; end

  # @return [Symbol, nil]
  #
  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:32
  def name; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:201
  def possible_types(type); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:270
  def preload; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:213
  def query_root; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:261
  def reachable_type?(type_name); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:221
  def subscription_root; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:162
  def type(type_name); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:266
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:17
    def from_context(ctx, schema); end

    # pkg:gem/graphql#lib/graphql/schema/visibility/profile.rb:25
    def null_profile(context:, schema:); end
  end
end

# pkg:gem/graphql#lib/graphql/schema/visibility.rb:11
class GraphQL::Schema::Visibility::TypeConfigurationError < ::GraphQL::Error
  # pkg:gem/graphql#lib/graphql/schema/visibility.rb:12
  def initialize(config_message, config_str); end
end

# pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:5
class GraphQL::Schema::Visibility::Visit
  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:6
  def initialize(schema, &visit_block); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:28
  def entry_point_directives; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:16
  def entry_point_types; end

  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:32
  def visit_each(types: T.unsafe(nil), directives: T.unsafe(nil)); end

  private

  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:127
  def append_unvisited_type(owner, type); end

  # pkg:gem/graphql#lib/graphql/schema/visibility/visit.rb:135
  def update_type_owner(owner, type); end
end
...
# @api private
#
# pkg:gem/graphql#lib/graphql/schema/warden.rb:14
class GraphQL::Schema::Warden
  # @param context [GraphQL::Query::Context]
  # @param schema [GraphQL::Schema]
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:200
  def initialize(context:, schema:); end

  # @param argument_owner [GraphQL::Field, GraphQL::InputObjectType]
  # @return [Array<GraphQL::Argument>] Visible arguments on `argument_owner`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:318
  def arguments(argument_owner, ctx = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:361
  def directives; end

  # @return [Array<GraphQL::EnumType::EnumValue>] Visible members of `enum_defn`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:333
  def enum_values(enum_defn); end

  # @param type_defn [GraphQL::ObjectType, GraphQL::InterfaceType]
  # @return [Array<GraphQL::Field>] Fields on `type_defn`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:311
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:279
  def get_field(parent_type, field_name); end

  # @return [GraphQL::BaseType, nil] The type named `type_name`, if it exists (else `nil`)
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:254
  def get_type(type_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:398
  def interface_type_memberships(obj_type, _ctx = T.unsafe(nil)); end

  # @return [Array<GraphQL::InterfaceType>] Visible interfaces implemented by `obj_type`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:350
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:234
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:242
  def loadable_possible_types(abstract_type, _ctx); end

  # @return [Array<GraphQL::BaseType>] The types which may be member of `type_defn`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:301
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:268
  def reachable_types; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:365
  def root_type_for_operation(op_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:218
  ...
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:116
  def visibility_profile; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:385
  def visible_argument?(arg_defn, _ctx = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:344
  def visible_enum_value?(enum_value, _ctx = T.unsafe(nil)); end

  # @param owner [Class, Module] If provided, confirm that field has the given owner.
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:375
  def visible_field?(field_defn, _ctx = T.unsafe(nil), owner = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:389
  def visible_type?(type_defn, _ctx = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:394
  def visible_type_membership?(type_membership, _ctx = T.unsafe(nil)); end

  private

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:503
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:454
  def field_on_visible_interface?(field_defn, type_defn); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:491
  def orphan_type?(type_defn); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:555
  def reachable_type_set; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:499
  def read_through; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:486
  def referenced?(type_defn); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:480
  def root_type?(type_defn); end

  # We need this to tell whether a field was inherited by an interface
  # even when that interface is hidden from `#interfaces`
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:446
  def unfiltered_interfaces(type_defn); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:439
  def union_memberships(obj_type); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:495
  def visible?(member); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:407
  def visible_and_reachable_type?(type_defn); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:593
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/schema/warden.rb:15
    def from_context(context); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:22
    def types_from_context(context); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:29
    def use(schema); end
...
# pkg:gem/graphql#lib/graphql/schema/warden.rb:539
...
class GraphQL::Schema::Warden::NullWarden
  ...
  #
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:89
  def skip_warning=(_arg0); end
  ...
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:94
  def visible_argument?(arg_defn, _ctx = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:96
  def visible_enum_value?(enum_value, _ctx = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:93
  def visible_field?(field_defn, _ctx = T.unsafe(nil), owner = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:95
  def visible_type?(type_defn, _ctx = T.unsafe(nil)); end
...
#
# pkg:gem/graphql#lib/graphql/schema/warden.rb:65
class GraphQL::Schema::Warden::PassThruWarden
  class << self
    # pkg:gem/graphql#lib/graphql/schema/warden.rb:73
    def arguments(owner, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:72
    def interface_type_memberships(obj_t, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:74
    def loadable?(type, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:75
    def loadable_possible_types(type, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:76
    def visibility_profile; end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:68
    def visible_argument?(arg, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:70
    def visible_enum_value?(ev, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:67
    def visible_field?(field, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:69
    def visible_type?(type, ctx); end

    # pkg:gem/graphql#lib/graphql/schema/warden.rb:71
...
class GraphQL::Schema::Warden::VisibilityProfile
  # pkg:gem/graphql#lib/graphql/schema/warden.rb:121
  def initialize(warden); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:173
  def all_types; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:141
  def argument(owner, arg_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:157
  def arguments(owner); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:129
  def directive_exists?(dir_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:125
  def directives; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:169
  def enum_values(enum_type); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:137
  def field(owner, field_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:161
  def fields(owner); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:177
  def interfaces(obj_type); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:181
  def loadable?(t, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:185
  def loadable_possible_types(t, ctx); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:149
  def mutation_root; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:165
  def possible_types(type); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:145
  def query_root; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:189
  def reachable_type?(type_name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:153
  def subscription_root; end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:133
  def type(name); end

  # pkg:gem/graphql#lib/graphql/schema/warden.rb:193
  def visible_enum_value?(enum_value, ctx = T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/schema/wrapper.rb:5
class GraphQL::Schema::Wrapper
  ...
  # pkg:gem/graphql#lib/graphql/schema/wrapper.rb:25
  def ==(other); end

  # pkg:gem/graphql#lib/graphql/schema/wrapper.rb:19
  def freeze; end

  # @return [Class, Module] The inner type of this wrapping type, the type of which one or more objects may be present.
  #
  # pkg:gem/graphql#lib/graphql/schema/wrapper.rb:9
  def of_type; end

  # pkg:gem/graphql#lib/graphql/schema/wrapper.rb:15
  def unwrap; end
end

# pkg:gem/graphql#lib/graphql/static_validation/error.rb:3
...
# don't exist, etc.
#
# pkg:gem/graphql#lib/graphql/static_validation/all_rules.rb:9
GraphQL::StaticValidation::ALL_RULES = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/static_validation/rules/argument_literals_are_compatible.rb:4
module GraphQL::StaticValidation::ArgumentLiteralsAreCompatible
  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_literals_are_compatible.rb:5
  def on_argument(node, parent); end
end
...
class GraphQL::StaticValidation::ArgumentLiteralsAreCompatibleError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_literals_are_compatible_error.rb:43
  def code; end
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/argument_names_are_unique.rb:4
module GraphQL::StaticValidation::ArgumentNamesAreUnique
  include ::GraphQL::StaticValidation::Error::ErrorHelper

  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_names_are_unique.rb:12
  def on_directive(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_names_are_unique.rb:7
  def on_field(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_names_are_unique.rb:17
...
class GraphQL::StaticValidation::ArgumentNamesAreUniqueError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/argument_names_are_unique_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/arguments_are_defined.rb:4
module GraphQL::StaticValidation::ArgumentsAreDefined
  # pkg:gem/graphql#lib/graphql/static_validation/rules/arguments_are_defined.rb:5
  def on_argument(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/arguments_are_defined.rb:47
  def node_type(parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/arguments_are_defined.rb:51
  def parent_definition(parent); end

  # TODO smell: these methods are added to all visitors, since they're included in a module.
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/arguments_are_defined.rb:34
...
class GraphQL::StaticValidation::BaseVisitor < ::GraphQL::Language::StaticVisitor
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:22
  def context; end

  # @return [Array<String>] The nesting of the current position in the AST
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:25
  def path; end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:215
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:33
    def including_rules(rules); end
  end
end

# pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:56
module GraphQL::StaticValidation::BaseVisitor::ContextMethods
  # @return [GraphQL::Argument, nil] The most-recently-entered GraphQL::Argument, if currently inside one
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:204
  def argument_definition; end

  # @return [GraphQL::Directive, nil] The most-recently-entered GraphQL::Directive, if currently inside one
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:199
  def directive_definition; end

  # @return [GraphQL::Field, nil] The most-recently-entered GraphQL::Field, if currently inside one
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:194
  def field_definition; end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:137
  def on_argument(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:129
  def on_directive(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:108
  def on_field(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:70
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:164
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:89
  def on_inline_fragment(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:171
  def on_input_object(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:57
  def on_operation_definition(node, parent); end

  # @return [GraphQL::BaseType] The type which the current type came from
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:189
  def parent_type_definition; end

  # @return [GraphQL::BaseType] The current object type
  #
  # pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:184
  def type_definition; end
end

# pkg:gem/graphql#lib/graphql/static_validation/base_visitor.rb:87
GraphQL::StaticValidation::BaseVisitor::ContextMethods::INLINE_FRAGMENT_NO_TYPE = T.let(T.unsafe(nil), String)
...
module GraphQL::StaticValidation::DefinitionDependencies
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:32
  def on_document(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:51
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:58
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:44
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:114
...
class GraphQL::StaticValidation::DefinitionDependencies::DependencyMap
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:93
  def [](definition_node); end

  # @return [Array<GraphQL::Language::Nodes::FragmentDefinition>]
  #
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:77
  def cyclical_definitions; end

  # @return [Hash<Node, Array<GraphQL::Language::Nodes::FragmentSpread>>]
  #
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:80
  def unmet_dependencies; end

  # @return [Array<GraphQL::Language::Nodes::FragmentDefinition>]
  #
  # pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:83
  def unused_dependencies; end
end

# pkg:gem/graphql#lib/graphql/static_validation/definition_dependencies.rb:98
...
class GraphQL::StaticValidation::DirectivesAreDefinedError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_defined_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:4
module GraphQL::StaticValidation::DirectivesAreInValidLocations
  include ::GraphQL::Language

  # pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:7
  def on_directive(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:53
  def assert_includes_location(directive_defn, directive_ast, required_location); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:35
  def validate_location(ast_directive, ast_parent, directives); end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:14
GraphQL::StaticValidation::DirectivesAreInValidLocations::LOCATION_MESSAGE_NAMES = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:25
GraphQL::StaticValidation::DirectivesAreInValidLocations::SIMPLE_LOCATIONS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations.rb:33
...
class GraphQL::StaticValidation::DirectivesAreInValidLocationsError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/directives_are_in_valid_locations_error.rb:15
  def to_h; end
end
...
class GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/error.rb:26
  def to_h; end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/error.rb:37
  def locations; end
end

# Convenience for validators
#
# pkg:gem/graphql#lib/graphql/static_validation/error.rb:7
module GraphQL::StaticValidation::Error::ErrorHelper
  # Error `error_message` is located at `node`
  #
  # pkg:gem/graphql#lib/graphql/static_validation/error.rb:9
  def error(error_message, nodes, context: T.unsafe(nil), path: T.unsafe(nil), extensions: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/fields_are_defined_on_type.rb:4
module GraphQL::StaticValidation::FieldsAreDefinedOnType
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_are_defined_on_type.rb:5
  def on_field(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_are_defined_on_type.rb:35
...
#
# pkg:gem/graphql#lib/graphql/static_validation/rules/fields_have_appropriate_selections.rb:6
module GraphQL::StaticValidation::FieldsHaveAppropriateSelections
  include ::GraphQL::StaticValidation::Error::ErrorHelper

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_have_appropriate_selections.rb:9
  def on_field(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_have_appropriate_selections.rb:15
  def on_operation_definition(node, _parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_have_appropriate_selections.rb:24
...
#
# pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge.rb:17
...
class GraphQL::StaticValidation::FieldsWillMergeError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:30
  def add_conflict(node, conflict_str); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:56
  def code; end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:26
  def conflicts; end
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:16
  def message; end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:20
  def message=(_arg0); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:22
  def path; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fields_will_merge_error.rb:44
  def to_h; end
end
...
module GraphQL::StaticValidation::FragmentNamesAreUnique
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_names_are_unique.rb:11
  def on_fragment_definition(node, parent); end
end
...
class GraphQL::StaticValidation::FragmentNamesAreUniqueError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_names_are_unique_error.rb:13
  def to_h; end
end
...
module GraphQL::StaticValidation::FragmentSpreadsArePossible
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_spreads_are_possible.rb:19
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_spreads_are_possible.rb:10
  def on_inline_fragment(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_spreads_are_possible.rb:42
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_types_exist.rb:4
module GraphQL::StaticValidation::FragmentTypesExist
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_types_exist.rb:5
  def on_fragment_definition(node, _parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_types_exist.rb:11
  def on_inline_fragment(node, _parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_types_exist.rb:19
...
class GraphQL::StaticValidation::FragmentTypesExistError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragment_types_exist_error.rb:24
  def code; end
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_finite.rb:4
module GraphQL::StaticValidation::FragmentsAreFinite
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_finite.rb:5
  def on_document(_n, _p); end
end
...
class GraphQL::StaticValidation::FragmentsAreFiniteError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_finite_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_named.rb:4
module GraphQL::StaticValidation::FragmentsAreNamed
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_named.rb:5
  def on_fragment_definition(node, _parent); end
end
...
class GraphQL::StaticValidation::FragmentsAreNamedError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_named_error.rb:21
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_named_error.rb:11
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_on_composite_types.rb:4
module GraphQL::StaticValidation::FragmentsAreOnCompositeTypes
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_on_composite_types.rb:5
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_on_composite_types.rb:9
  def on_inline_fragment(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_on_composite_types.rb:15
...
class GraphQL::StaticValidation::FragmentsAreOnCompositeTypesError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_on_composite_types_error.rb:25
  def code; end
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_used.rb:4
module GraphQL::StaticValidation::FragmentsAreUsed
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_used.rb:5
  def on_document(node, parent); end
end
...
class GraphQL::StaticValidation::FragmentsAreUsedError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/fragments_are_used_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/input_object_names_are_unique.rb:4
module GraphQL::StaticValidation::InputObjectNamesAreUnique
  # pkg:gem/graphql#lib/graphql/static_validation/rules/input_object_names_are_unique.rb:5
  def on_input_object(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/input_object_names_are_unique.rb:12
...
class GraphQL::StaticValidation::InputObjectNamesAreUniqueError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/input_object_names_are_unique_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/interpreter_visitor.rb:4
class GraphQL::StaticValidation::InterpreterVisitor < ::GraphQL::StaticValidation::BaseVisitor
  ...
  include ::GraphQL::StaticValidation::SubscriptionRootExistsAndSingleSubscriptionSelection
...
class GraphQL::StaticValidation::LiteralValidator
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:13
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:143
  def ensure_array(value); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:86
  def maybe_raise_if_invalid(ast_value); end

  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:147
  def merge_results(results_list); end

  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:132
  def present_input_field_values_are_valid(type, ast_node); end

  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:34
  def recursively_validate(ast_value, type); end

  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:21
  def replace_nulls_in(ast_value); end

  # pkg:gem/graphql#lib/graphql/static_validation/literal_validator.rb:109
  def required_input_fields_are_present(type, ast_node); end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/mutation_root_exists.rb:4
module GraphQL::StaticValidation::MutationRootExists
  # pkg:gem/graphql#lib/graphql/static_validation/rules/mutation_root_exists.rb:5
  def on_operation_definition(node, _parent); end
end
...
class GraphQL::StaticValidation::MutationRootExistsError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/mutation_root_exists_error.rb:21
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/mutation_root_exists_error.rb:11
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:4
module GraphQL::StaticValidation::NoDefinitionsArePresent
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:33
  def on_document(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:24
  def on_enum_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:31
  def on_enum_type_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:21
  def on_input_object_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:28
  def on_input_object_type_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:22
  def on_interface_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:29
  def on_interface_type_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:12
  def on_invalid_node(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:20
  def on_object_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:27
  def on_object_type_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:19
  def on_scalar_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:26
  def on_scalar_type_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:18
  def on_schema_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:25
  def on_schema_extension(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:23
  def on_union_type_definition(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present.rb:30
  def on_union_type_extension(node, parent); end
end
...
class GraphQL::StaticValidation::NoDefinitionsArePresentError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present_error.rb:20
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/no_definitions_are_present_error.rb:10
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/not_single_subscription_error.rb:4
class GraphQL::StaticValidation::NotSingleSubscriptionError < ::GraphQL::StaticValidation::Error
  # pkg:gem/graphql#lib/graphql/static_validation/rules/not_single_subscription_error.rb:5
  def initialize(message, path: T.unsafe(nil), nodes: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/not_single_subscription_error.rb:20
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/not_single_subscription_error.rb:10
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/one_of_input_objects_are_valid.rb:4
module GraphQL::StaticValidation::OneOfInputObjectsAreValid
  # pkg:gem/graphql#lib/graphql/static_validation/rules/one_of_input_objects_are_valid.rb:5
  def on_input_object(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/one_of_input_objects_are_valid.rb:17
...
class GraphQL::StaticValidation::OneOfInputObjectsAreValidError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/one_of_input_objects_are_valid_error.rb:13
  def to_h; end
end
...
module GraphQL::StaticValidation::OperationNamesAreValid
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/operation_names_are_valid.rb:10
  def on_operation_definition(node, parent); end
end
...
class GraphQL::StaticValidation::OperationNamesAreValidError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/operation_names_are_valid_error.rb:13
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/query_root_exists.rb:4
module GraphQL::StaticValidation::QueryRootExists
  # pkg:gem/graphql#lib/graphql/static_validation/rules/query_root_exists.rb:5
  def on_operation_definition(node, _parent); end
end
...
class GraphQL::StaticValidation::QueryRootExistsError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/query_root_exists_error.rb:21
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/query_root_exists_error.rb:11
  def to_h; end
end
...
module GraphQL::StaticValidation::RequiredArgumentsArePresent
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_arguments_are_present.rb:10
  def on_field(node, _parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_arguments_are_present.rb:23
...
class GraphQL::StaticValidation::RequiredArgumentsArePresentError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_arguments_are_present_error.rb:17
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/required_input_object_attributes_are_present.rb:4
module GraphQL::StaticValidation::RequiredInputObjectAttributesArePresent
  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_input_object_attributes_are_present.rb:5
  def on_input_object(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_input_object_attributes_are_present.rb:14
  def get_parent_type(context, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_input_object_attributes_are_present.rb:33
...
class GraphQL::StaticValidation::RequiredInputObjectAttributesArePresentError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/required_input_object_attributes_are_present_error.rb:17
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/subscription_root_exists_and_single_subscription_selection.rb:4
module GraphQL::StaticValidation::SubscriptionRootExistsAndSingleSubscriptionSelection
  # pkg:gem/graphql#lib/graphql/static_validation/rules/subscription_root_exists_and_single_subscription_selection.rb:5
  def on_operation_definition(node, parent); end
end
...
class GraphQL::StaticValidation::SubscriptionRootExistsError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/subscription_root_exists_error.rb:21
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/subscription_root_exists_error.rb:11
  def to_h; end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location.rb:4
module GraphQL::StaticValidation::UniqueDirectivesPerLocation
  # pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location.rb:32
  def on_enum_type_definition(node, parent); end
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location.rb:37
  def validate_directive_location(node); end
end

# pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location.rb:5
GraphQL::StaticValidation::UniqueDirectivesPerLocation::DIRECTIVE_NODE_HOOKS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location.rb:22
GraphQL::StaticValidation::UniqueDirectivesPerLocation::VALIDATE_DIRECTIVE_LOCATION_ON_NODE = T.let(T.unsafe(nil), String)
...
class GraphQL::StaticValidation::UniqueDirectivesPerLocationError < ::GraphQL::StaticValidation::Error
  ...
  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/unique_directives_per_location_error.rb:13
  def to_h; end
end
...
#
# pkg:gem/graphql#lib/graphql/static_validation/validation_context.rb:11
class GraphQL::StaticValidation::ValidationContext
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/validation_context.rb:37
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/validation_context.rb:49
  def schema_directives; end

  # pkg:gem/graphql#lib/graphql/static_validation/validation_context.rb:45
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/validation_context.rb:41
...
class GraphQL::StaticValidation::ValidationTimeoutError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/validation_timeout_error.rb:20
  def code; end

  # A hash representation of this Message
  #
  # pkg:gem/graphql#lib/graphql/static_validation/validation_timeout_error.rb:10
  def to_h; end
end
...
class GraphQL::StaticValidation::Validator
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/validator.rb:75
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/variable_default_values_are_correctly_typed.rb:4
module GraphQL::StaticValidation::VariableDefaultValuesAreCorrectlyTyped
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_default_values_are_correctly_typed.rb:5
  def on_variable_definition(node, parent); end
end
...
class GraphQL::StaticValidation::VariableDefaultValuesAreCorrectlyTypedError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_default_values_are_correctly_typed_error.rb:34
  def code; end
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/variable_default_values_are_correctly_typed_error.rb:9
GraphQL::StaticValidation::VariableDefaultValuesAreCorrectlyTypedError::VIOLATIONS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/static_validation/rules/variable_names_are_unique.rb:4
module GraphQL::StaticValidation::VariableNamesAreUnique
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_names_are_unique.rb:5
  def on_operation_definition(node, parent); end
end
...
class GraphQL::StaticValidation::VariableNamesAreUniqueError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_names_are_unique_error.rb:24
  def code; end
...
module GraphQL::StaticValidation::VariableUsagesAreAllowed
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_usages_are_allowed.rb:11
  def on_operation_definition(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_usages_are_allowed.rb:91
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_usages_are_allowed.rb:133
  def list_dimension(type); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_usages_are_allowed.rb:143
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variable_usages_are_allowed.rb:102
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_input_types.rb:4
module GraphQL::StaticValidation::VariablesAreInputTypes
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_input_types.rb:5
  def on_variable_definition(node, parent); end

  private

  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_input_types.rb:42
...
class GraphQL::StaticValidation::VariablesAreInputTypesError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_input_types_error.rb:27
  def code; end
...
module GraphQL::StaticValidation::VariablesAreUsedAndDefined
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:48
  def on_fragment_definition(node, parent); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:59
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:33
  def on_operation_definition(node, parent); end
  ...
  #  - assign its AST node
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:68
  def on_variable_identifier(node, parent); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:124
  ...
  #
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined.rb:94
...
class GraphQL::StaticValidation::VariablesAreUsedAndDefinedError < ::GraphQL::StaticValidation::Error
  ...
  # pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined_error.rb:32
  def code; end
...
# pkg:gem/graphql#lib/graphql/static_validation/rules/variables_are_used_and_defined_error.rb:8
...
# pkg:gem/graphql#lib/graphql/subscriptions/broadcast_analyzer.rb:4
class GraphQL::Subscriptions
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:40
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:233
  def broadcastable?(query_str, **query_options); end

  # @return [String] A new unique identifier for a subscription
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:216
  def build_id; end

  # @return [Boolean] Used when fields don't have `broadcastable:` explicitly set
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:50
  ...
  # @return void.
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:211
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:158
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:177
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:104
  def execute_update(subscription_id, event, object); end

  # pkg:gem/graphql#lib/graphql/subscriptions.rb:262
  def finalizer; end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:255
  def finish_subscriptions(query); end

  # Called during execution when a new `subscription ...` operation is received
  # @param query [GraphQL::Query]
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:245
  def initialize_subscriptions(query); end
  ...
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:228
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:185
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:60
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:150
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:203
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions.rb:285
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/subscriptions.rb:25
...
#
# pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:85
class GraphQL::Subscriptions::ActionCableSubscriptions < ::GraphQL::Subscriptions
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:91
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:226
  def delete_subscription(subscription_id); end

  # This subscription was re-evaluated.
  # Send it to the specific stream where this client was waiting.
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:127
  def deliver(subscription_id, result); end

  # An event was triggered; Push the data over ActionCable.
  # Subscribers will re-evaluate locally.
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:119
  def execute_all(event, object); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:199
  def load_action_cable_message(message, context); end

  # Return the query from "storage" (in memory)
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:208
  def read_subscription(subscription_id); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:168
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:137
  def write_subscription(query, events); end

  private

  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:251
  def stream_event_name(event); end

  # pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:247
  def stream_subscription_name(subscription_id); end
end

# pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:87
GraphQL::Subscriptions::ActionCableSubscriptions::EVENT_PREFIX = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/subscriptions/action_cable_subscriptions.rb:86
...
class GraphQL::Subscriptions::BroadcastAnalyzer < ::GraphQL::Analysis::Analyzer
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/broadcast_analyzer.rb:49
  def result; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/broadcast_analyzer.rb:57
  def apply_broadcastable(owner_type, field_defn); end
end

# pkg:gem/graphql#lib/graphql/subscriptions/default_subscription_resolve_extension.rb:4
class GraphQL::Subscriptions::DefaultSubscriptionResolveExtension < ::GraphQL::Schema::FieldExtension
  # pkg:gem/graphql#lib/graphql/subscriptions/default_subscription_resolve_extension.rb:34
  def after_resolve(context:, arguments:, values: T.unsafe(nil), value: T.unsafe(nil), objects: T.unsafe(nil), object: T.unsafe(nil), **rest); end

  # pkg:gem/graphql#lib/graphql/subscriptions/default_subscription_resolve_extension.rb:5
  def resolve(context:, arguments:, object: T.unsafe(nil), objects: T.unsafe(nil)); end

  class << self
    # pkg:gem/graphql#lib/graphql/subscriptions/default_subscription_resolve_extension.rb:44
    def write_subscription(field, value, arguments, context); end
  end
end
...
class GraphQL::Subscriptions::Event
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:13
  def arguments; end

  # @return [GraphQL::Query::Context]
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:16
  def context; end

  # @return [String] a logical identifier for this event. (Stable when the query is broadcastable.)
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:48
  def fingerprint; end

  # @return [String] Corresponds to the Subscription root field name
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:10
  def name; end

  # @return [String] An opaque string which identifies this event, derived from `name` and `arguments`
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:19
  def topic; end

  class << self
    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:64
    def arguments_without_field_extras(arguments:, field:); end

    # @return [String] an identifier for this unit of subscription
    #
    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:40
    def serialize(_name, arguments, field, scope:, context: T.unsafe(nil)); end

    private

    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:92
    ...
    #
    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:79
    def deep_sort_hash_keys(hash_to_sort); end

    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:150
    def get_arg_definition(arg_owner, arg_name, context); end

    # pkg:gem/graphql#lib/graphql/subscriptions/event.rb:105
    def stringify_args(arg_owner, args, context); end
  end
end

# pkg:gem/graphql#lib/graphql/subscriptions.rb:266
class GraphQL::Subscriptions::Finalizer
  include ::GraphQL::Execution::Finalizer

  # pkg:gem/graphql#lib/graphql/subscriptions.rb:268
  def initialize(subscriptions); end

  # pkg:gem/graphql#lib/graphql/subscriptions.rb:272
  def finalize_graphql_result(query, result_data, result_key); end
end
...
#
# pkg:gem/graphql#lib/graphql/subscriptions.rb:14
...
module GraphQL::Subscriptions::Serialize
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/serialize.rb:26
  def dump(obj); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/subscriptions/serialize.rb:19
  def load(str); end
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/subscriptions/serialize.rb:56
...
#
# pkg:gem/graphql#lib/graphql/subscriptions.rb:21
class GraphQL::Subscriptions::SubscriptionScopeMissingError < ::GraphQL::Error; end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:3
module GraphQL::Testing; end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:4
module GraphQL::Testing::Helpers
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:42
  def run_graphql_field(schema, field_path, object, arguments: T.unsafe(nil), context: T.unsafe(nil), ast_node: T.unsafe(nil), lookahead: T.unsafe(nil), visibility_profile: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:107
  def with_resolution_context(schema, type:, object:, context: T.unsafe(nil), visibility_profile: T.unsafe(nil)); end

  class << self
    # @param schema_class [Class<GraphQL::Schema>]
    # @return [Module] A helpers module which always uses the given schema
    #
    # pkg:gem/graphql#lib/graphql/testing/helpers.rb:7
    def for(schema_class); end
  end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:11
class GraphQL::Testing::Helpers::Error < ::GraphQL::Error; end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:35
class GraphQL::Testing::Helpers::FieldNotDefinedError < ::GraphQL::Testing::Helpers::Error
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:36
  def initialize(type_name:, field_name:); end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:21
class GraphQL::Testing::Helpers::FieldNotVisibleError < ::GraphQL::Testing::Helpers::Error
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:22
  def initialize(type_name:, field_name:); end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:119
class GraphQL::Testing::Helpers::ResolutionAssertionContext
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:120
  def initialize(test, type_name:, object:, schema:, context:, visibility_profile:); end

  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:131
  def run_graphql_field(field_name, arguments: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:129
  def visibility_profile; end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:140
module GraphQL::Testing::Helpers::SchemaHelpers
  include ::GraphQL::Testing::Helpers

  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:143
  def run_graphql_field(field_path, object, arguments: T.unsafe(nil), context: T.unsafe(nil), visibility_profile: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:147
  def with_resolution_context(*args, **kwargs, &block); end

  class << self
    # pkg:gem/graphql#lib/graphql/testing/helpers.rb:152
    def for(schema_class); end
  end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:28
class GraphQL::Testing::Helpers::TypeNotDefinedError < ::GraphQL::Testing::Helpers::Error
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:29
  def initialize(type_name:); end
end

# pkg:gem/graphql#lib/graphql/testing/helpers.rb:14
class GraphQL::Testing::Helpers::TypeNotVisibleError < ::GraphQL::Testing::Helpers::Error
  # pkg:gem/graphql#lib/graphql/testing/helpers.rb:15
  def initialize(type_name:); end
end
...
#
# pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:40
class GraphQL::Testing::MockActionCable
  class << self
    # Implements Rails API
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:87
    def broadcast(stream_name, message); end

    # Call this before each test run to make sure that MockActionCable's data is empty
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:77
    def clear_mocks; end
    ...
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:100
    def get_mock_channel; end

    # Used by mock code
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:93
    def mock_stream_for(stream_name); end

    # @return [Array<String>] Streams that currently have subscribers
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:105
    def mock_stream_names; end

    # Implements Rails API
    #
    # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:82
    def server; end
  end
end

# pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:41
class GraphQL::Testing::MockActionCable::MockChannel
  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:42
  def initialize; end

  # @return [Array<Hash>] Payloads "sent" to this channel by GraphQL-Ruby
  #
  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:47
  def mock_broadcasted_messages; end

  # Called by ActionCableSubscriptions. Implements a Rails API.
  #
  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:50
...
# @api private
#
# pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:59
class GraphQL::Testing::MockActionCable::MockStream
  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:60
  def initialize; end

  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:64
  def add_mock_channel(channel, handler); end

  # pkg:gem/graphql#lib/graphql/testing/mock_action_cable.rb:68
  def mock_broadcast(message); end
end

# pkg:gem/graphql#lib/graphql/tracing.rb:5
...
#   end
#
# pkg:gem/graphql#lib/graphql/tracing/active_support_notifications_trace.rb:20
module GraphQL::Tracing::ActiveSupportNotificationsTrace
  include ::GraphQL::Tracing::NotificationsTrace

  # pkg:gem/graphql#lib/graphql/tracing/active_support_notifications_trace.rb:22
...
#
# pkg:gem/graphql#lib/graphql/tracing/active_support_notifications_tracing.rb:11
module GraphQL::Tracing::ActiveSupportNotificationsTracing
  class << self
    # pkg:gem/graphql#lib/graphql/tracing/active_support_notifications_tracing.rb:16
...
#
# pkg:gem/graphql#lib/graphql/tracing/active_support_notifications_tracing.rb:13
...
#
# pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:19
module GraphQL::Tracing::AppOpticsTrace
  include ::GraphQL::Tracing::PlatformTrace

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:47
  def analyze_multiplex(**data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:47
  def analyze_query(**data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:96
  def authorized(**data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:107
  def authorized_lazy(**data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:66
  def execute_field(query:, field:, ast_node:, arguments:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:92
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:147
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:143
  def platform_field_key(field); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:151
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:118
  def resolve_type(**data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:130
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:157
  def gql_config; end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:210
  def graphql_context(context, layer); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:236
  def graphql_multiplex(data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:218
  def graphql_query(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:229
  def graphql_query_string(query_string); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:190
  def metadata(data, layer); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:172
  def multiplex_transaction_name(names); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:252
  def remove_comments(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:243
  def sanitize(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:182
  ...
  class << self
    # pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:31
    def version; end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:23
GraphQL::Tracing::AppOpticsTrace::EXEC_KEYS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:141
...
#
# pkg:gem/graphql#lib/graphql/tracing/appoptics_trace.rb:21
...
class GraphQL::Tracing::AppOpticsTracing < ::GraphQL::Tracing::PlatformTracing
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:64
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:72
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:49
  def platform_trace(platform_key, _key, data); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:78
  def gql_config; end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:131
  def graphql_context(context, layer); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:157
  def graphql_multiplex(data); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:139
  def graphql_query(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:150
  def graphql_query_string(query_string); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:111
  def metadata(data, layer); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:93
  def multiplex_transaction_name(names); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:173
  def remove_comments(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:164
  def sanitize(query); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:103
  def span_name(key); end

  # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:82
  def transaction_name(query); end
  ...
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:34
    def version; end
  end
end
...
# These GraphQL events will show up as 'graphql.execute' spans
#
# pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:23
GraphQL::Tracing::AppOpticsTracing::EXEC_KEYS = T.let(T.unsafe(nil), Array)

# These GraphQL events will show up as 'graphql.prep' spans
#
# pkg:gem/graphql#lib/graphql/tracing/appoptics_tracing.rb:21
...
#   end
#
# pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:12
module GraphQL::Tracing::AppsignalTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:12
  def end_authorized(type, object, context, result); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:12
  def setup_appsignal_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:12
  def begin_appsignal_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:12
  def finish_appsignal_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:23
class GraphQL::Tracing::AppsignalTrace::AppsignalMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:24
  def instrument(keyword, object); end
end

# pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:38
class GraphQL::Tracing::AppsignalTrace::AppsignalMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:43
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_trace.rb:39
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::AppsignalTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::AppsignalTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:7
class GraphQL::Tracing::AppsignalTracing < ::GraphQL::Tracing::PlatformTracing
  # @param set_action_name [Boolean] If true, the GraphQL operation name will be used as the transaction name.
  #   This is not advised if you run more than one query per HTTP request, for example, with `graphql-client` or multiplexing.
  #   It can also be specified per-query with `context[:set_appsignal_action_name]`.
  #
  # pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:22
  def initialize(options = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:44
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:40
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:48
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/appsignal_tracing.rb:27
...
#
# pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:8
module GraphQL::Tracing::CallLegacyTracers
  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:21
  def analyze_multiplex(multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:25
  def analyze_query(query:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:49
  def authorized(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:53
  def authorized_lazy(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:41
  def execute_field(field:, query:, ast_node:, arguments:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:45
  def execute_field_lazy(field:, query:, ast_node:, arguments:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:29
  def execute_multiplex(multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:33
  def execute_query(query:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:37
  def execute_query_lazy(query:, multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:9
  def lex(query_string:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:13
  def parse(query_string:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:57
  def resolve_type(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:61
  def resolve_type_lazy(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/call_legacy_tracers.rb:17
  def validate(query:, validate:); end
end
...
module GraphQL::Tracing::DataDogTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:13
  def setup_datadog_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:13
  def begin_datadog_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:13
  def finish_datadog_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::DataDogTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:15
class GraphQL::Tracing::DataDogTrace::DatadogMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:16
  def initialize(set_transaction_name:, service: T.unsafe(nil), tracer: T.unsafe(nil), **_rest); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:28
  def instrument(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:26
...
# pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:58
class GraphQL::Tracing::DataDogTrace::DatadogMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:64
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_trace.rb:59
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::DataDogTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:7
class GraphQL::Tracing::DataDogTracing < ::GraphQL::Tracing::PlatformTracing
  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:65
  def analytics_enabled?; end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:70
  def analytics_sample_rate; end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:79
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:75
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:83
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:19
  def platform_trace(platform_key, key, data); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:55
  def prepare_span(key, data, span); end

  # pkg:gem/graphql#lib/graphql/tracing/data_dog_tracing.rb:58
  def tracer; end
end
...
#
# pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:5
class GraphQL::Tracing::DetailedTrace
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:84
  def initialize(storage:, trace_mode:, debug:); end

  # @return [Boolean]
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:99
  def debug?; end

  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:121
  def delete_all_traces; end

  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:116
  def delete_trace(id); end

  # @return [StoredTrace, nil]
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:111
  def find_trace(id); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:125
  def inspect_object(object); end

  # @return [String] ID of saved trace
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:94
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:91
  def trace_mode; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:106
  ...
  class << self
    ...
    # @return [true]
    #
    # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:139
    def debug?; end

    # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:129
    def inspect_object(object); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:69
    def use(schema, trace_mode: T.unsafe(nil), memory: T.unsafe(nil), debug: T.unsafe(nil), redis: T.unsafe(nil), limit: T.unsafe(nil), model_class: T.unsafe(nil)); end
  end
end
...
#
# pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:8
class GraphQL::Tracing::DetailedTrace::MemoryBackend
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:9
  def initialize(limit: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:36
  def delete_all_traces; end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:31
  def delete_trace(id); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:27
  def find_trace(id); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:41
  def save_trace(operation_name, duration, begin_ms, trace_data); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/memory_backend.rb:15
  def traces(last:, before:); end
end

# pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:6
class GraphQL::Tracing::DetailedTrace::RedisBackend
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:8
  def initialize(redis:, limit: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:32
  def delete_all_traces; end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:27
  def delete_trace(id); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:36
  def find_trace(id); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:45
  def save_trace(operation_name, duration_ms, begin_ms, trace_data); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:14
  def traces(last:, before:); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:59
  def entry_to_trace(id, json_str); end
end

# pkg:gem/graphql#lib/graphql/tracing/detailed_trace/redis_backend.rb:7
GraphQL::Tracing::DetailedTrace::RedisBackend::KEY_PREFIX = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:143
class GraphQL::Tracing::DetailedTrace::StoredTrace
  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:144
  def initialize(id:, operation_name:, duration_ms:, begin_ms:, trace_data:); end

  # pkg:gem/graphql#lib/graphql/tracing/detailed_trace.rb:152
  def begin_ms; end
...
# pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:5
module GraphQL::Tracing::LegacyHooksTrace
  # pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:6
  def execute_multiplex(multiplex:); end
end

# pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:17
module GraphQL::Tracing::LegacyHooksTrace::RunHooks
  private

  # pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:62
  def call_after_hooks(instrumenters, object, after_hook_name, ex); end

  # Call each before hook, and if they all succeed, yield.
  # If they don't all succeed, call after_ for each one that succeeded.
  #
  # pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:37
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/legacy_hooks_trace.rb:22
...
# pkg:gem/graphql#lib/graphql/tracing/legacy_trace.rb:8
...
#
# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:9
module GraphQL::Tracing::MonitorTrace
  class << self
    # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:135
    def create_module(monitor_name); end
  end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:149
GraphQL::Tracing::MonitorTrace::MODULE_TEMPLATE = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:10
class GraphQL::Tracing::MonitorTrace::Monitor
  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:11
  def initialize(trace:, set_transaction_name:, **_rest); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:44
  def fallback_transaction_name(context); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:20
  def instrument(keyword, object, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:48
  def name_for(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:24
  def start_event(keyword, object); end

  # Get the transaction name based on the operation type and name if possible, or fall back to a user provided
  # one. Useful for anonymous queries.
  #
  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:32
  def transaction_name(query); end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:68
class GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:69
  def initialize(monitor, keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:81
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:75
  def keyword; end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:75
  def object; end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:77
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:110
module GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames
  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:121
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:117
  def platform_field_key(field); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:125
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:129
  def platform_source_class_key(source_class); end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:115
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames::ANALYZE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:114
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames::EXECUTE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:112
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames::LEX_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:111
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames::PARSE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:113
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames::VALIDATE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:86
module GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames
  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:97
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:93
  def platform_field_key(field); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:101
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:105
  def platform_source_class_key(source_class); end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:91
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames::ANALYZE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:90
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames::EXECUTE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:88
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames::LEX_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:87
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames::PARSE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:89
GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames::VALIDATE_NAME = T.let(T.unsafe(nil), String)
...
module GraphQL::Tracing::NewRelicTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:19
  def setup_newrelic_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:19
  def begin_newrelic_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:19
  def finish_newrelic_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::NewRelicTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:21
class GraphQL::Tracing::NewRelicTrace::NewrelicMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:28
  def instrument(keyword, payload, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:47
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:43
  def platform_field_key(field); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:51
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:39
  def platform_source_class_key(source_class); end
end

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:26
GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::ANALYZE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:25
GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::EXECUTE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:55
class GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:61
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:56
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:23
GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::LEX_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:22
GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::PARSE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_trace.rb:24
GraphQL::Tracing::NewRelicTrace::NewrelicMonitor::VALIDATE_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::NewRelicTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:7
class GraphQL::Tracing::NewRelicTracing < ::GraphQL::Tracing::PlatformTracing
  # @param set_transaction_name [Boolean] If true, the GraphQL operation name will be used as the transaction name.
  #   This is not advised if you run more than one query per HTTP request, for example, with `graphql-client` or multiplexing.
  #   It can also be specified per-query with `context[:set_new_relic_transaction_name]`.
  #
  # pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:22
  def initialize(options = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:44
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:40
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:48
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/new_relic_tracing.rb:27
  def platform_trace(platform_key, key, data); end
end
...
#
# pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:9
module GraphQL::Tracing::NotificationsTrace
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:77
  def initialize(engine:, **rest); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:107
  def begin_analyze_multiplex(multiplex, analyzers); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:146
  def begin_authorized(type, object, context); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:166
  def begin_dataloader_source(source); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:123
  def begin_execute_field(field, object, arguments, query); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:156
  def begin_resolve_type(type, object, context); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:138
  def dataloader_fiber_resume(source); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:133
  def dataloader_fiber_yield(source); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:112
  def end_analyze_multiplex(_multiplex, _analyzers); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:151
  def end_authorized(type, object, context, result); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:171
  def end_dataloader_source(source); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:128
  def end_execute_field(_field, _object, _arguments, _query, _result); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:161
  def end_resolve_type(type, object, context, resolved_type); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:117
  def execute_multiplex(**payload); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:95
  def lex(**payload); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:89
  def parse(**payload); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:101
  def validate(**payload); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:181
  def begin_notifications_event(name, payload); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:185
  def finish_notifications_event; end
end
...
class GraphQL::Tracing::NotificationsTrace::ActiveSupportNotificationsAdapter::Event < ::GraphQL::Tracing::NotificationsTrace::Adapter::Event
  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:69
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:64
  def start; end
end

# @api private
#
# pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:11
class GraphQL::Tracing::NotificationsTrace::Adapter
  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:12
  def instrument(keyword, payload, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:16
  def start_event(keyword, payload); end
end

# pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:22
class GraphQL::Tracing::NotificationsTrace::Adapter::Event
  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:23
  def initialize(name, payload); end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:34
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:28
  def name; end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:28
  def payload; end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:30
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:176
GraphQL::Tracing::NotificationsTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)
...
class GraphQL::Tracing::NotificationsTrace::DryMonitorAdapter::Event < ::GraphQL::Tracing::NotificationsTrace::Adapter::Event
  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:51
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:47
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/notifications_trace.rb:177
GraphQL::Tracing::NotificationsTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)
...
# @see KEYS for event names
#
# pkg:gem/graphql#lib/graphql/tracing/notifications_tracing.rb:12
class GraphQL::Tracing::NotificationsTracing
  # Initialize a new NotificationsTracing instance
  #
  # @param [Object] notifications_engine The notifications engine to use
  #
  # pkg:gem/graphql#lib/graphql/tracing/notifications_tracing.rb:35
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/notifications_tracing.rb:49
  def trace(key, metadata, &blk); end
end

# A cache of frequently-used keys to avoid needless string allocations
#
# pkg:gem/graphql#lib/graphql/tracing/notifications_tracing.rb:14
GraphQL::Tracing::NotificationsTracing::KEYS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/tracing/notifications_tracing.rb:30
GraphQL::Tracing::NotificationsTracing::MAX_KEYS_SIZE = T.let(T.unsafe(nil), Integer)

# pkg:gem/graphql#lib/graphql/tracing/null_trace.rb:7
GraphQL::Tracing::NullTrace = T.let(T.unsafe(nil), GraphQL::Tracing::Trace)

# pkg:gem/graphql#lib/graphql/tracing.rb:68
module GraphQL::Tracing::NullTracer
  private

  # pkg:gem/graphql#lib/graphql/tracing.rb:70
  def trace(k, v); end
...
#   end
#
# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:30
module GraphQL::Tracing::PerfettoTrace
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:78
  def initialize(active_support_notifications_pattern: T.unsafe(nil), save_profile: T.unsafe(nil), **_rest); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:291
  def begin_analyze_multiplex(m, analyzers); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:513
  def begin_authorized(type, obj, ctx); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:455
  def begin_dataloader(dl); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:475
  def begin_dataloader_source(source); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:254
  def begin_execute_field(field, object, arguments, query); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:543
  def begin_resolve_type(type, value, context); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:338
  def begin_validate(query, validate); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:443
  def dataloader_fiber_exit; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:424
  def dataloader_fiber_resume(source); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:402
  def dataloader_fiber_yield(source); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:376
  def dataloader_spawn_execution_fiber(jobs); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:389
  def dataloader_spawn_source_fiber(pending_sources); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:306
  def end_analyze_multiplex(m, analyzers); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:527
  def end_authorized(type, obj, ctx, is_authorized); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:466
  def end_dataloader(dl); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:500
  def end_dataloader_source(source); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:268
  def end_execute_field(field, object, arguments, query, app_result); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:557
  def end_resolve_type(type, value, context, resolved_type); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:352
  def end_validate(query, validate, validation_errors); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:224
  def execute_multiplex(multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:318
  def parse(query_string:); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:577
  def write(file:, debug_json: T.unsafe(nil)); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:727
  def count_allocations; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:731
  def count_fibers(diff); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:735
  def count_fields; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:626
  def debug_annotation(iid, value_key, value); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:739
  def dup_with(message, attrs, delete_counters: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:749
  def fiber_flow_stack; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:606
  def fid; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:767
  def new_interned_data; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:634
  def payload_to_debug(k, v, iid: T.unsafe(nil), intern_value: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:823
  def subscribe_to_active_support_notifications(pattern); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:602
  def tid; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:753
  def trace_packet(timestamp: T.unsafe(nil), **event_attrs); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:794
  def track_descriptor_packet(parent_uuid, uuid, name, counter: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:598
  def ts; end

  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:817
  def unsubscribe_from_active_support_notifications; end

  class << self
    # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:45
    def included(_trace_class); end
  end
end

# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:53
GraphQL::Tracing::PerfettoTrace::ACTIVE_SUPPORT_NOTIFICATIONS_CATEGORY_IIDS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:70
GraphQL::Tracing::PerfettoTrace::ANON_CLASS_NAME = T.let(T.unsafe(nil), String)
...
# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:610
class GraphQL::Tracing::PerfettoTrace::ArgumentsFilter
  # pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:616
  def filter_param(key, value); end
end

# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:614
GraphQL::Tracing::PerfettoTrace::ArgumentsFilter::FILTERED = T.let(T.unsafe(nil), String)
...
#
# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:34
GraphQL::Tracing::PerfettoTrace::PROTOBUF_AVAILABLE = T.let(T.unsafe(nil), FalseClass)

# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:55
GraphQL::Tracing::PerfettoTrace::RESOLVE_TYPE_CATEGORY_IIDS = T.let(T.unsafe(nil), Array)

# pkg:gem/graphql#lib/graphql/tracing/perfetto_trace.rb:63
GraphQL::Tracing::PerfettoTrace::REVERSE_DEBUG_NAME_LOOKUP = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:5
module GraphQL::Tracing::PlatformTrace
  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:6
  def initialize(trace_scalars: T.unsafe(nil), **_options); end

  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:28
  def platform_authorized_lazy(key, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:24
  def platform_execute_field_lazy(*args, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:32
  def platform_resolve_type_lazy(key, &block); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:118
  def fallback_transaction_name(context); end

  # Get the transaction name based on the operation type and name if possible, or fall back to a user provided
  # one. Useful for anonymous queries.
  #
  # pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:106
  def transaction_name(query); end
...
# pkg:gem/graphql#lib/graphql/tracing/platform_trace.rb:13
...
class GraphQL::Tracing::PlatformTracing
  ...
  # @return [String]
  #
  # pkg:gem/graphql#lib/graphql/tracing/platform_tracing.rb:130
  def cached_platform_key(ctx, key, trace_phase); end

  # pkg:gem/graphql#lib/graphql/tracing/platform_tracing.rb:110
  def fallback_transaction_name(context); end

  # pkg:gem/graphql#lib/graphql/tracing/platform_tracing.rb:114
  def options; end

  # Get the transaction name based on the operation type and name if possible, or fall back to a user provided
  # one. Useful for anonymous queries.
  #
  # pkg:gem/graphql#lib/graphql/tracing/platform_tracing.rb:98
  def transaction_name(query); end
...
#
# pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:29
module GraphQL::Tracing::PrometheusTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:43
  def prometheus_client; end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:43
  def prometheus_collector_type; end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:43
  def prometheus_keys_whitelist; end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:29
  def setup_prometheus_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:29
  def begin_prometheus_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:29
  def finish_prometheus_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::PrometheusTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::PrometheusTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:45
class GraphQL::Tracing::PrometheusTrace::PrometheusMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:58
  def active?(keyword); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:62
  def gettime; end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:46
  def instrument(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:66
  def send_json(duration, keyword, object); end
end

# pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:78
class GraphQL::Tracing::PrometheusTrace::PrometheusMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:83
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_trace.rb:79
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:7
class GraphQL::Tracing::PrometheusTracing < ::GraphQL::Tracing::PlatformTracing
  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:24
  def initialize(opts = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:41
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:37
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:45
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:32
  def platform_trace(platform_key, key, _data, &block); end

  private

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:51
  def instrument_execution(platform_key, key, &block); end

  # pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:59
  def observe(platform_key, key, duration); end
end

# pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:9
GraphQL::Tracing::PrometheusTracing::DEFAULT_COLLECTOR_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/graphql#lib/graphql/tracing/prometheus_tracing.rb:8
...
module GraphQL::Tracing::ScoutTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:13
  def setup_scout_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:13
  def begin_scout_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:13
  def finish_scout_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::ScoutTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::ScoutTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:15
class GraphQL::Tracing::ScoutTrace::ScoutMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames

  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:16
  def instrument(keyword, object); end
end

# pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:34
class GraphQL::Tracing::ScoutTrace::ScoutMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:42
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:35
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/scout_trace.rb:30
GraphQL::Tracing::ScoutTrace::ScoutMonitor::INSTRUMENT_OPTS = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:7
class GraphQL::Tracing::ScoutTracing < ::GraphQL::Tracing::PlatformTracing
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:24
  def initialize(options = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:47
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:43
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:51
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:30
  def platform_trace(platform_key, key, data); end
end

# pkg:gem/graphql#lib/graphql/tracing/scout_tracing.rb:8
...
module GraphQL::Tracing::SentryTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/sentry_trace.rb:14
  def setup_sentry_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/sentry_trace.rb:14
  def begin_sentry_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/sentry_trace.rb:14
  def finish_sentry_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::SentryTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::SentryTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/sentry_trace.rb:16
class GraphQL::Tracing::SentryTrace::SentryMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames

  # pkg:gem/graphql#lib/graphql/tracing/sentry_trace.rb:17
  def instrument(keyword, object); end
...
module GraphQL::Tracing::StatsdTrace
  ...
  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:17
  def setup_statsd_monitor(trace_scalars: T.unsafe(nil), trace_authorized: T.unsafe(nil), trace_resolve_type: T.unsafe(nil), set_transaction_name: T.unsafe(nil), **kwargs); end
  ...
  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:17
  def begin_statsd_event(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:17
  def finish_statsd_event; end
end

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:263
GraphQL::Tracing::StatsdTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/monitor_trace.rb:264
GraphQL::Tracing::StatsdTrace::PREVIOUS_EV_KEY = T.let(T.unsafe(nil), Symbol)

# pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:19
class GraphQL::Tracing::StatsdTrace::StatsdMonitor < ::GraphQL::Tracing::MonitorTrace::Monitor
  include ::GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames

  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:20
  def initialize(statsd:, **_rest); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:27
  def instrument(keyword, object); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:25
  def statsd; end
end

# pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:35
class GraphQL::Tracing::StatsdTrace::StatsdMonitor::Event < ::GraphQL::Tracing::MonitorTrace::Monitor::Event
  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:40
  def finish; end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_trace.rb:36
  def start; end
end

# pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:7
class GraphQL::Tracing::StatsdTracing < ::GraphQL::Tracing::PlatformTracing
  # @param statsd [Object] A statsd client
  #
  # pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:20
  def initialize(statsd:, **rest); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:35
  def platform_authorized_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:31
  def platform_field_key(type, field); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:39
  def platform_resolve_type_key(type); end

  # pkg:gem/graphql#lib/graphql/tracing/statsd_tracing.rb:25
  def platform_trace(platform_key, key, data); end
end
...
class GraphQL::Tracing::Trace
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:16
  def initialize(multiplex: T.unsafe(nil), query: T.unsafe(nil), **_options); end

  # @param multiplex [GraphQL::Execution::Multiplex]
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:52
  def analyze_multiplex(multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:56
  def analyze_query(query:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:97
  def authorized(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:123
  def authorized_lazy(query:, type:, object:); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:45
  def begin_analyze_multiplex(multiplex, analyzers); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:112
  def begin_authorized(type, object, context); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:155
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:164
  def begin_dataloader_source(source); end
  ...
  # @param query [GraphQL::Query]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:80
  def begin_execute_field(field, object, arguments, query); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:140
  def begin_resolve_type(type, value, context); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:36
  def begin_validate(query, validate); end

  # Called when an execution or source fiber terminates
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:180
  def dataloader_fiber_exit; end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:189
  def dataloader_fiber_resume(source); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:185
  def dataloader_fiber_yield(source); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:173
  def dataloader_spawn_execution_fiber(jobs); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:177
  def dataloader_spawn_source_fiber(pending_sources); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:49
  def end_analyze_multiplex(multiplex, analyzers); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:120
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:159
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:168
  def end_dataloader_source(source); end
  ...
  # @param result [Object]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:87
  def end_execute_field(field, object, arguments, query, result); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:149
  def end_resolve_type(type, value, context, resolved_type); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:39
  def end_validate(query, validate, errors); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:89
  def execute_field(field:, query:, ast_node:, arguments:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:93
  def execute_field_lazy(field:, query:, ast_node:, arguments:, object:); end
  ...
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:63
  def execute_multiplex(multiplex:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:67
  def execute_query(query:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:71
  def execute_query_lazy(query:, multiplex:); end

  # The Ruby parser doesn't call this method (`graphql/c_parser` does.)
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:22
  def lex(query_string:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:104
  def object_loaded(argument_definition, object, context); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:101
  def objects(type, object, context); end

  # @param query_string [String]
  # @return [void]
  #
  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:28
  def parse(query_string:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:127
  def resolve_type(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:131
  def resolve_type_lazy(query:, type:, object:); end

  # pkg:gem/graphql#lib/graphql/tracing/trace.rb:32
  def validate(query:, validate:); end
end
...
# @api private
#
# pkg:gem/graphql#lib/graphql/tracing.rb:41
module GraphQL::Tracing::Traceable
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing.rb:45
  ...
  #
  # pkg:gem/graphql#lib/graphql/tracing.rb:59
...
class GraphQL::TypeKinds::TypeKind
  ...
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:24
  def abstract?; end

  # Is this TypeKind composed of many values?
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:35
  def composite?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:7
  def description; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:53
  def enum?; end

  # Does this TypeKind have queryable fields?
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:26
  def fields?; end
  ...
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:57
  def input_object?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:45
  def interface?; end

  # Is this TypeKind a primitive value?
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:33
  def leaf?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:61
  def list?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:7
  def name; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:65
  def non_null?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:41
  def object?; end

  # Does this TypeKind have multiple possible implementers?
  # @deprecated Use `abstract?` instead of `resolves?`.
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:22
  def resolves?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:37
  def scalar?; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:31
  def to_s; end

  # pkg:gem/graphql#lib/graphql/type_kinds.rb:49
  def union?; end

  # Does this TypeKind modify another type?
  #
  # pkg:gem/graphql#lib/graphql/type_kinds.rb:28
  def wraps?; end
end

# pkg:gem/graphql#lib/graphql/type_kinds.rb:74
GraphQL::TypeKinds::UNION = T.let(T.unsafe(nil), GraphQL::TypeKinds::TypeKind)

# pkg:gem/graphql#lib/graphql/types.rb:4
module GraphQL::Types
  extend ::GraphQL::Autoload
end

# pkg:gem/graphql#lib/graphql/types/big_int.rb:5
class GraphQL::Types::BigInt < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/big_int.rb:8
    def coerce_input(value, _ctx); end

    # pkg:gem/graphql#lib/graphql/types/big_int.rb:14
    def coerce_result(value, _ctx); end

    # pkg:gem/graphql#lib/graphql/types/big_int.rb:18
    def parse_int(value); end
  end
end

# pkg:gem/graphql#lib/graphql/types/boolean.rb:4
class GraphQL::Types::Boolean < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/boolean.rb:7
    def coerce_input(value, _ctx); end

    # pkg:gem/graphql#lib/graphql/types/boolean.rb:11
    def coerce_result(value, _ctx); end
  end
end

# pkg:gem/graphql#lib/graphql/types/float.rb:5
...
# pkg:gem/graphql#lib/graphql/types/id.rb:4
class GraphQL::Types::ID < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/id.rb:12
    def coerce_input(value, _ctx); end

    # pkg:gem/graphql#lib/graphql/types/id.rb:8
    def coerce_result(value, _ctx); end
  end
end
...
# own Date type.
#
# pkg:gem/graphql#lib/graphql/types/iso_8601_date.rb:15
...
# own DateTime type.
#
# pkg:gem/graphql#lib/graphql/types/iso_8601_date_time.rb:18
...
#
# pkg:gem/graphql#lib/graphql/types/iso_8601_date_time.rb:24
...
# own Duration type.
#
# pkg:gem/graphql#lib/graphql/types/iso_8601_duration.rb:16
class GraphQL::Types::ISO8601Duration < ::GraphQL::Schema::Scalar
  class << self
    ...
    #
    # pkg:gem/graphql#lib/graphql/types/iso_8601_duration.rb:57
    def coerce_input(value, ctx); end
    ...
    #
    # pkg:gem/graphql#lib/graphql/types/iso_8601_duration.rb:33
    def coerce_result(value, _ctx); end

    # @return [Integer, nil]
    #
    # pkg:gem/graphql#lib/graphql/types/iso_8601_duration.rb:20
    def seconds_precision; end

    # @param [Integer, nil] value
    #
    # pkg:gem/graphql#lib/graphql/types/iso_8601_duration.rb:26
...
#
# pkg:gem/graphql#lib/graphql/types/int.rb:6
class GraphQL::Types::Int < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/int.rb:12
    def coerce_input(value, ctx); end

    # pkg:gem/graphql#lib/graphql/types/int.rb:23
    def coerce_result(value, ctx); end
  end
end

# pkg:gem/graphql#lib/graphql/types/int.rb:10
GraphQL::Types::Int::MAX = T.let(T.unsafe(nil), Integer)

# pkg:gem/graphql#lib/graphql/types/int.rb:9
...
#
# pkg:gem/graphql#lib/graphql/types/json.rb:13
class GraphQL::Types::JSON < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/json.rb:16
    def coerce_input(value, _context); end

    # pkg:gem/graphql#lib/graphql/types/json.rb:20
...
#
# pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:5
...
module GraphQL::Types::Relay::ClassMethods
  # pkg:gem/graphql#lib/graphql/types/relay/page_info_behaviors.rb:28
  def default_broadcastable?; end
...
# pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:6
module GraphQL::Types::Relay::ConnectionBehaviors
  ...
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:206
  def nodes; end
...
# pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:25
module GraphQL::Types::Relay::ConnectionBehaviors::ClassMethods
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:118
  def authorized?(obj, ctx); end

  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:46
  def default_broadcastable(new_value); end

  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:42
  def default_broadcastable?; end

  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:38
  def default_relay?; end

  # @return [Class]
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:54
  def edge_class; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:149
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:67
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:139
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:159
  def has_nodes_field(new_value = T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:26
  def inherited(child_class); end

  # Set the default `node_nullable` for this class and its child classes. (Defaults to `true`.)
  # Use `node_nullable(false)` in your base class to make non-null `node` and `nodes` fields.
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:129
  def node_nullable(new_value = T.unsafe(nil)); end

  # @return [Class]
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:51
  def node_type; end

  # Add the shortcut `nodes` field to this connection and its subclasses
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:114
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:101
  def reauthorize_scoped_objects(new_value = T.unsafe(nil)); end
  ...
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:122
  def visible?(ctx); end
  ...
  # pkg:gem/graphql#lib/graphql/types/relay/connection_behaviors.rb:173
  def define_nodes_field(nullable, field_options: T.unsafe(nil)); end
end

# pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:6
module GraphQL::Types::Relay::EdgeBehaviors
  mixes_in_class_methods ::GraphQL::Types::Relay::EdgeBehaviors::ClassMethods

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:16
  def node; end
...
# pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:24
module GraphQL::Types::Relay::EdgeBehaviors::ClassMethods
  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:68
  def authorized?(obj, ctx); end

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:40
  def default_broadcastable(new_value); end

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:36
  def default_broadcastable?; end

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:32
  def default_relay?; end

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:25
  def inherited(child_class); end

  # Set the default `node_nullable` for this class and its child classes. (Defaults to `true`.)
  # Use `node_nullable(false)` in your base class to make non-null `node` field.
  #
  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:78
  def node_nullable(new_value = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:49
  def node_type(node_type = T.unsafe(nil), null: T.unsafe(nil), field_options: T.unsafe(nil)); end

  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:72
  def visible?(ctx); end
  ...
  # Use `node_nullable(false)` in your base class to make non-null `node` field.
  #
  # pkg:gem/graphql#lib/graphql/types/relay/edge_behaviors.rb:88
...
#
# pkg:gem/graphql#lib/graphql/types/relay/has_node_field.rb:7
module GraphQL::Types::Relay::HasNodeField
  mixes_in_class_methods ::GraphQL::Types::Relay::HasNodeField::ExecutionMethods

  # pkg:gem/graphql#lib/graphql/types/relay/has_node_field.rb:19
  def get_relay_node(id:); end

  class << self
    # pkg:gem/graphql#lib/graphql/types/relay/has_node_field.rb:36
    def field_block; end

    # pkg:gem/graphql#lib/graphql/types/relay/has_node_field.rb:24
...
module GraphQL::Types::Relay::HasNodeField::ExecutionMethods
  # pkg:gem/graphql#lib/graphql/types/relay/has_node_field.rb:14
  def get_relay_node(context, id:); end
end
...
#
# pkg:gem/graphql#lib/graphql/types/relay/has_nodes_field.rb:7
module GraphQL::Types::Relay::HasNodesField
  mixes_in_class_methods ::GraphQL::Types::Relay::HasNodesField::ExecutionMethods

  # pkg:gem/graphql#lib/graphql/types/relay/has_nodes_field.rb:19
  def get_relay_nodes(ids:); end

  class << self
    # pkg:gem/graphql#lib/graphql/types/relay/has_nodes_field.rb:36
    def field_block; end

    # pkg:gem/graphql#lib/graphql/types/relay/has_nodes_field.rb:24
    def field_options; end
...
module GraphQL::Types::Relay::HasNodesField::ExecutionMethods
  # pkg:gem/graphql#lib/graphql/types/relay/has_nodes_field.rb:14
  def get_relay_nodes(context, ids:); end
end
...
#
# pkg:gem/graphql#lib/graphql/types/relay/node.rb:9
module GraphQL::Types::Relay::Node
  ...
  extend ::GraphQL::Types::Relay::NodeBehaviors::ExecutionMethods

  mixes_in_class_methods ::GraphQL::Types::Relay::NodeBehaviors::ExecutionMethods
end

# pkg:gem/graphql#lib/graphql/types/relay/node.rb:10
class GraphQL::Types::Relay::Node::UnresolvedTypeError < ::GraphQL::UnresolvedTypeError; end

# pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:6
module GraphQL::Types::Relay::NodeBehaviors
  mixes_in_class_methods ::GraphQL::Types::Relay::NodeBehaviors::ClassMethods
  mixes_in_class_methods ::GraphQL::Types::Relay::NodeBehaviors::ExecutionMethods

  # pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:14
...
module GraphQL::Types::Relay::NodeBehaviors::ClassMethods
  # pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:19
  def default_relay?; end
end

# pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:24
module GraphQL::Types::Relay::NodeBehaviors::ExecutionMethods
  # pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:25
  def default_global_id(object, context); end

  # pkg:gem/graphql#lib/graphql/types/relay/node_behaviors.rb:29
  def included(child_class); end
end

# The return type of a connection's `pageInfo` field
#
# pkg:gem/graphql#lib/graphql/types/relay/page_info.rb:6
...
# pkg:gem/graphql#lib/graphql/types/relay/page_info_behaviors.rb:5
...
# pkg:gem/graphql#lib/graphql/types/string.rb:5
class GraphQL::Types::String < ::GraphQL::Schema::Scalar
  class << self
    # pkg:gem/graphql#lib/graphql/types/string.rb:22
    def coerce_input(value, _ctx); end

    # pkg:gem/graphql#lib/graphql/types/string.rb:8
    def coerce_result(value, ctx); end
  end
end

# pkg:gem/graphql#lib/graphql/unauthorized_enum_value_error.rb:3
class GraphQL::UnauthorizedEnumValueError < ::GraphQL::UnauthorizedError
  # pkg:gem/graphql#lib/graphql/unauthorized_enum_value_error.rb:7
  ...
  #
  # pkg:gem/graphql#lib/graphql/unauthorized_enum_value_error.rb:5
  def enum_value; end
...
class GraphQL::UnauthorizedError < ::GraphQL::RuntimeError
  ...
  # pkg:gem/graphql#lib/graphql/unauthorized_error.rb:31
  def ast_nodes; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/unauthorized_error.rb:15
  def context; end
  ...
  # pkg:gem/graphql#lib/graphql/unauthorized_error.rb:33
  def finalize_graphql_result(query, result_data, key); end

  # @return [Object] the application object that failed the authorization check
  #
  # pkg:gem/graphql#lib/graphql/unauthorized_error.rb:9
  def object; end
  ...
  #
  # pkg:gem/graphql#lib/graphql/unauthorized_error.rb:12
  def type; end
end
...
class GraphQL::UnauthorizedFieldError < ::GraphQL::UnauthorizedError
  ...
  #
  # pkg:gem/graphql#lib/graphql/unauthorized_field_error.rb:5
  def field; end
...
class GraphQL::UnresolvedTypeError < ::GraphQL::RuntimeTypeError
  ...
  #
  # pkg:gem/graphql#lib/graphql/unresolved_type_error.rb:10
  def field; end

  # @return [GraphQL::BaseType] The owner of `field`
  #
  # pkg:gem/graphql#lib/graphql/unresolved_type_error.rb:13
  def parent_type; end

  # @return [Array<GraphQL::BaseType>] The allowed options for resolving `value` to `field.type`
  #
  # pkg:gem/graphql#lib/graphql/unresolved_type_error.rb:19
  def possible_types; end

  # @return [Object] The return of {Schema#resolve_type} for `value`
  #
  # pkg:gem/graphql#lib/graphql/unresolved_type_error.rb:16
  def resolved_type; end

  # @return [Object] The runtime value which couldn't be successfully resolved with `resolve_type`
  #
  # pkg:gem/graphql#lib/graphql/unresolved_type_error.rb:7
  def value; end
end

# pkg:gem/graphql#lib/graphql/version.rb:3
